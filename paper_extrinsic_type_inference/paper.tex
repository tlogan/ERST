...
Treating the parameter \code{f} is allowed in systems that have impredicative parametric polymorphism \cite{}, which
...
For instance, \code{forall 'a . 'a -> 'a}, \code{forall 'a . 'a -> 'a list}, \code{forall 'a . 'a -> 'a option}, 

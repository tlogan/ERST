...
\TODO{Model Typing Soundness}

To characterize the meaning of types, model typing describes how the various forms of types are introduced
based on the various forms of values. There are no rules for elimination 
...
the typing or subtyping are valid if and only if they are valid for all interpretations of the variables $\vec{\alpha}$.
If a variable is not in $\vec{\alpha}$  

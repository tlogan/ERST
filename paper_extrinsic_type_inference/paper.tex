...
\begin{theorem}
  ...
  \item \I\I \N Derive $(
    \delta' \oplus \delta \satisfies e[\sigma] \hastype \J{<}l\J{>}\alpha
  )$ [Thm. \ref{thm:model_typing_subsumption}]

  \item \I\I \N Derive $(
    \delta' \oplus \delta \satisfies (e[\sigma])\J{.}l
  )$ [Thm. \ref{thm:model_typing_entry_elimination}]

  \item \I\I \N Derive $(
    \delta' \oplus \delta \satisfies (e\J{.}l)[\sigma]
  )$ [Def. \ref{def:expr_substitution}]
...
by applying 
Theorem \ref{thm:model_typing_subsumption}.
...
by applying Theorem \ref{thm:model_typing_subsumption}.
...
$
by applying (P1), (P2), and Theorem \ref{thm:model_typing_subsumption}.
...
Theorem \ref{thm:model_typing_subsumption},
Theorem \ref{thm:model_typing_entry_elimination},
and

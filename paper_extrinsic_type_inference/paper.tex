...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \\\\
      \exists \alpha  \qua \J{LFP[} \alpha_\mu \J{]}\tau_\mu \subtypes \alpha \J{*} \J{TOP} \factorsinto \tau_l \subtypes \alpha
      \\
      \exists \alpha  \qua \J{LFP[} \alpha_\mu \J{]}\tau_\mu \subtypes \J{TOP} \J{*} \alpha \factorsinto \tau_r \subtypes \alpha 
    } {
...
\begin{property} 
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \delta \cup \delta' \cup \delta^\dagger \satisfies (e_a \J{,BOT}) \hastype \tau^\dagger 
      )
      )
      \implies
      \\\\
...
\begin{theorem}
  ...
  \begin{mathpar}
    \inferrule {
      \tau_l \subtypes \tau_r \factorsinto \tau \subtypes \alpha
    } {
      \forall \delta \qua
      \delta \satisfies \tau_l \subtypes \tau_r
      \implies
      \delta \satisfies \tau \subtypes \alpha
    }
  \end{mathpar}
\end{theorem}
\hfill
...
\begin{theorem}
  \label{theorem:subtyping_positive_substitution}
  Subtyping Positive Substitution 
  \\
  \begin{mathpar}
    \inferrule {
      \delta \satisfies \tau_l \subtypes \tau_r
      ...
      \delta \satisfies \tau_l\subtypes \tau_r[\alpha \slash \tau]^+
    }
  \end{mathpar}
\end{theorem}
\hfill
...
\forall \delta^\dagger \qua \textbf{dom}(\delta^\dagger) \cong \Theta^\dagger \implies
(
\exists \delta'', e_a \qua
\textbf{dom}(\delta'') \cap \textbf{ftv}(\Delta') \up
\delta' \cup \delta \cup \delta'' \cup \delta^\dagger \satisfies \Delta^\dagger \up
\delta' \cup \delta \cup \delta'' \cup \delta^\dagger \satisfies \J{loop(}e[\sigma]\J{)(} e_a \J{)} \hastype \tau^\dagger
)
)
$
by Theorem \ref{...} (Duality Soundness).

We derive
$... \satisfies e_a\J{,loop(}e[\sigma]\J{)(} e_a \J{)} \hastype \tau^\dagger$
by ....

We derive
$... \satisfies e_a\J{,loop(}e[\sigma]\J{)(} e_a \J{)} \hastype \tau_\mu$
by ....

We derive
$... \satisfies e_a\J{,loop(}e[\sigma]\J{)(} e_a \J{)} \hastype \J{LFP[} \alpha_\mu \J{]}\tau_\mu$
by ....

We derive
$... \satisfies e_a\J{,loop(}e[\sigma]\J{)(} e_a \J{)} \hastype \tau_l \J{\&} \tau_r$
by ....


We derive
$\forall e_a \qua \J{loop(}e[\sigma]\J{)(} e_a \J{)} \hastype \J{TOP} \implies ... \satisfies e_a\J{,loop(}e[\sigma]\J{)(} e_a \J{)} \hastype \tau_l \J{\&} \tau_r$
by ....

We derive
$... \satisfies \J{loop(}e[\sigma]\J{)} \hastype \tau_l \J{->} \tau_r$
by ....

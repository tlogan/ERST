...
\begin{theorem}
  ...
  \item \I \N And P: $(
    ...
    \delta', \sigma \satisfies \Gamma
    \implies 
    \delta' \oplus \delta \satisfies \J{@} \hastype \J{@} 
  )$ [IH]
  ...
  \item \I\I \N Derive $(
    \delta' \oplus \delta \satisfies \J{@}[\sigma] \hastype \J{@}
  ...
  \item \I \N And P: $(
    ...
    \delta', \sigma \satisfies \Gamma
    \implies 
    \delta' \oplus \delta \satisfies x \hastype \tau 
  )$ [IH]
  ...
  \item \I\I \N Derive $(
    \delta' \oplus \delta \satisfies x[\sigma] \hastype \tau
  ...
  \item \I \N And P: $(
    ...
    \delta', \sigma \satisfies \Gamma
    \implies 
    \delta' \oplus \delta \satisfies \epsilon \hastype \J{TOP} 
  )$ [IH]
  ...
  \item \I\I \N Derive $(
    \delta' \oplus \delta \satisfies \epsilon[\sigma] \hastype \J{TOP}
  )$ [Def. \ref{def:expr_substitution}]
...
Theorem \ref{thm:model_subtyping_sequence_elimination},
...
and 
Theorem \ref{thm:model_subtyping_sequence_interpretation_independence}.
...
and applying
Theorem \ref{thm:model_typing_interpretation_independence}.
...
Theorem \ref{thm:proof_typing_containment},
and
Theorem \ref{thm:model_typing_sequence_interpretation_independence}.
...
and
Theorem \ref{thm:model_subtyping_sequence_introduction}.
We derive
$(
\forall \Theta^\dagger, \Delta^\dagger, \tau^\dagger \qua 
(\Theta^\dagger, \Delta^\dagger, \tau^\dagger) \in \Pi_\nu \implies

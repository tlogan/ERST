...
proof typing infers a type and a subtyping sequence,
...
and consolidates the results into a sequence of schemes \ms{\Pi}.
...
\TODO{check if packing is actually necessary here}
...
to rewrite each scheme into a type,

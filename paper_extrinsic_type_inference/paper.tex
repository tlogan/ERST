...
Theorem \ref{thm:function_lifting_skolem_freshness}, and Theorem \ref{prop:packaging_correspondence}, along with a little
rewriting.
...
by applying 
Theorem \ref{...} (Duality Correspondence)
and
Theorem \ref{thm:packaging_correspondence}.
...
by applying 
Theorem \ref{thm:subtyping_factorization_correspondence}.
Theorem \ref{thm:subsumption},

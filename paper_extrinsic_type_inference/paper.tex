...
\begin{definition} 
  ...
  \[
  \begin{array}[t]{r@{}c@{}lcl}
      \llbracket \vec{\alpha}_\ignore, \vec{\alpha}_\closed \entails \Delta, \epsilon \rrbracket^\pm
      &\ =\ & 
      (\Delta', \epsilon')
      && 
      ...
      \llbracket \vec{\alpha}_\ignore, \vec{\alpha}_\closed \entails \Delta, \Delta_q \J{;} \tau_l \J{<:} \tau_r \rrbracket^\pm
      &\ =\ & 

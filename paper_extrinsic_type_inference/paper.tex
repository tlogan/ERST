...
An expression may consist of variables \ms{x}, unit \code{@},
records \ms{... \J{<}l\J{>} e ...}, functions \ms{...\J{[}p \J{=>} e \J{]}...}, 
projection \ms{e\J{.}l}, application \ms{e\J{(}e\J{)}}, 
recursion \ms{\J{loop(}e\J{)}},
annotations \ms{\J{def}\ x\ \J{:}\ \tau\ \J{=}\ e\ \J{in}\ e},

...
\begin{theorem}
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \exists \Theta, \Delta \qua \Theta, \Delta \entails \Omega \given \Theta', \Delta'
    }
  \end{mathpar}
\end{theorem}
...
\begin{theorem}
  ...
  \item \I \N Derive $(
    ...
    \Theta' \cup \Theta_l, \Delta' \entails
    \tau_l \subtypes \tau_r \given \Theta'', \Delta''
  )$ [Thm. \ref{thm:proof_decidable_subtyping_environment_uniqueness}]
  ...
  \item \I\I \N Derive $(
    \delta' \cup \delta_0 \satisfies \Omega
    \implies
    \delta' \cup \delta_0 \cup \delta_1 \satisfies \tau_l \subtypes \tau_r 
  )$ [Thm. \ref{thm:proof_decidable_subtyping_environment_completeness}, P1]

  \TODO{something is off with application of completeness; implication in premise}

  \item \I\I \N Derive $(
    \delta' \cup \delta_0 \cup \delta_1 \satisfies \Omega
    \implies
    \delta' \cup \delta_0 \cup \delta_1 \satisfies \tau_l \subtypes \tau_r 
  )$ [

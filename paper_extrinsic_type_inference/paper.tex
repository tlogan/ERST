...
\begin{theorem}
  \label{thm:model_subtyping_lfp_introduction}
  Model Subtyping Least Fixed Point Introduction 
  \\
  \begin{mathpar}
    \inferrule {
    } {
      \delta\ \alpha \slash \J{LFP[} \alpha \J{]} \tau \satisfies
      \tau \subtypes \J{LFP[} \alpha \J{]} \tau
    }
  \end{mathpar}
\end{theorem}
\hfill
...
\begin{theorem}
  \label{thm:model_typing_not_free_independence}
  Model Typing Not Free Independence 
  \\
  \begin{mathpar}
    \inferrule {
      \\
      ...
      \delta \satisfies e \hastype \tau
      \iff
      \delta\ \alpha \slash \tau' \satisfies
      e \hastype \tau
    }
  \end{mathpar}
\end{theorem}
...
\begin{theorem}
  ...
  %   \delta \oplus \delta \satisfies \Delta' 
  %   \implies 
  %   \delta' \oplus \delta \satisfies \Delta[\alpha\slash\tau]^{+} \backslash \Delta 
  % )$ [IH]
  ...
  )$ [Thm. \ref{thm:type_substitution_correspondence}, Thm. \ref{thm:model_typing_not_free_independence}, Thm. \ref{thm:model_subtyping_lfp_introduction},
Def. \ref{def:type_substitution}, Def. \ref{def:ftv}, Def. \ref{def:model_subtyping}]

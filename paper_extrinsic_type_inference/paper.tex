...
\TODO{rename consistency properties to non-vacuity}
\TODO{note how without non-vacuity it could be constructs a vacuous type with an erroneous program as its proof}
...
$
by Theorem \ref{thm:model_typing_path_elimination_loop}.
...
by applying 
Theorem \ref{thm:model_typing_path_elimination_loop}

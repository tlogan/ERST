...
constructors $\J{<}l\J{>} e$,
records, $...\J{?}l \entrymap e ...$, functions $...\J{?}p \J{=>} e ...$, record
...
\begin{definition} 
  ...
  \\
  \begin{align*}
      \llbracket e_l \J{,} e_r \rrbracket^\square &= \J{?left}\entrymap e_l \ \J{?right}\entrymap e_r
      \\
...
\begin{definition} Patterns 
  ...
  \[\begin{array}[t]{r@{}l@{}r}
    ...
    & \com{record}
    \\
    \nonterm{k} & \is \J{?}l \entrymap p
    & \com{entry}
  \end{array}\]
\end{definition}
\hfill

A pattern may be composed of variables, unit, constructors, or records. 
...
\begin{definition} Values 
  ...
  \[\begin{array}[t]{r@{}l@{}r}
    ...
    & \com{record}
    \\
    \nonterm{g} & \is \J{?}l \entrymap v
    & \com{entry}
  \end{array}\]
\end{definition}
\hfill

A value may be composed of unit, constructors, records, or functions. 
...
A base type reflects the structure of its inhabitants and may be composed of unit $\J{@}$, constructors $\J{<}l\J{>}\tau$,
entries $l \entrymap \tau$, and paths $\tau \J{->} \tau$.

\TODO{maybe test out treating constructors as syntactic sugar}
...
\begin{definition} 
  ...
  \begin{align*}
    ...
    \\
    \llbracket \tau_l \J{*} \tau_r \rrbracket^\square &= (\J{left} \entrymap \tau_l)  \J{\&} (\J{right} \entrymap \tau_r)
  \end{align*}
\end{definition} 
\hfill
...
\begin{definition}
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \vec{r}\J{?}l \entrymap e \rightsquigarrow \vec{r}\J{?}l \entrymap e' 
    }

    \inferrule {
      \vec{r} \rightsquigarrow \vec{r}'
    } {
      \vec{r} \J{?}l \entrymap v \rightsquigarrow \vec{r}'\J{?} l \entrymap v
    }
...
\begin{definition}
  ...
  \begin{mathpar}
    ...
    \inferrule { 
      \J{?}l \entrymap v \in \vec{g}
      \\
      \vec{\delta} \satisfies v \hastype \tau 
      \\
      \forall v' .\ \J{?} l \entrymap v' \in \vec{g} \implies v' = v
    } {
      \vec{\delta} \satisfies \vec{g} \hastype l \entrymap \tau
    } 
...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \Gamma \entails \vec{r}\ \J{?}l \entrymap e \hastype \tau\ \J{\&}\ l \entrymap \tau' \given \Omega' 
    }
    ...
    \inferrule {
      ...
      \Omega \preceq \Omega'
      \\
      \tau_0 \subtypes l \entrymap \alpha \given \Omega' 
    } {
...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      l \entrymap \tau_l \subtypes l \entrymap \tau_r \given \Omega 
    }

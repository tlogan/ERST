...
There are three type forms that imply the structures of the values contained in them.
For unit, reflexivity already preserves the type form.
For the other two forms, entries and paths,
proof subtyping preserves the form if the type's constituent parts meet certain criteria. 

...
\begin{definition}
  ...
  \begin{mathpar}
    ...
    \inferrule { 
      ...
      \vec{\delta} \satisfies \epsilon \hastype \J{TOP}
    } 
    ...
    \inferrule { 
      ...
      \\
      \text{dom}(\vec{\delta}') \cong \vec{\alpha}
    } {
    ...
    \inferrule { 
      ...
      \vec{\delta} \satisfies e \hastype \J{ALL[}\vec{\alpha}\ \Delta \J{]} \tau
    } 
...
\begin{property}
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \exists \vec{\delta} .\ \text{dom}(\vec{\delta}) \cong \vec{\alpha} \land
      (
...
holds only if the typing holds under some interpretation of type variables in $\vec{\alpha}$.
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \forall \vec{\alpha}'\ \Delta' .\ 
        \vec{\alpha}', \llbracket \alpha_\ignore \cup \vec{\alpha}' \entails \Delta', \alpha_l \J{->} \alpha_r \rrbracket^+ \in \vec{\pi}_\nu
      \implies
...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \vec{\alpha}', \llbracket \vec{\alpha}_\ignore \cup \vec{\alpha}' \entails \Delta', \tau_l \J{->} \tau_r \rrbracket^+ \in \vec{\pi}'
      \implies
...
\begin{property}
  ...
  \begin{mathpar}
    \inferrule { 
      ...
      \\
      \vec{\alpha} \subseteq \text{dom}(\vec{\delta}')
    } {
      \exists \delta .\ 
      (
      \vec{\delta} \cup \vec{\delta}' \satisfies \Delta
...
holds only if the model subtyping holds under some interpretation of type variables in $\vec{\alpha}$.
...
\begin{definition} 
  ...
  \hfill
  \boxed{
    \llbracket \vec{\alpha} \star \Delta, \alpha \rrbracket^\pm = (\Delta', \tau)
  }
  \\
  \[
  \begin{array}[t]{r@{}c@{}lcl}
...
\begin{definition} 
  ...
  \hfill
  \boxed{
    \vec{\alpha}, \Delta, \alpha \looparrowright^\pm \tau_l \subtypes \tau_r 
  }
  \\
  \begin{mathpar}
    \inferrule {
      ...
      \\\\
      \alpha' \in \text{FTV}(\tau) \backslash \vec{\alpha}
      \\
      \J{;}\alpha'\J{<:}\tau' \in \Delta 
    } {

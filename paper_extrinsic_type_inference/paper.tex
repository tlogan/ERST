...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \\
      \Theta', \Delta' \entails \tau \circledast \Pi_\nu
      \\\\
      \alpha_\nu \downarrow \Pi_\nu
      \fallingdotseq 
...
\begin{definition}
  ...
  \hfill 
  \boxed{\Theta, \Delta \entails \tau \circledast \Pi}
  \\
  \begin{mathpar}
    \inferrule {
      ...
      \Theta, \Delta \entails \tau \circledast \Pi 
    }
  \end{mathpar}
\end{definition}
\hfill
...
\begin{theorem}
  ...
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta, \Gamma \entails \tau \circledast \Pi 
    } {
      ...
      \delta' \cup \delta \satisfies \tau \subtypes \tau^\dagger
      )
      )
    }
  \end{mathpar}

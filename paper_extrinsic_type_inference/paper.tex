...
\begin{definition}
  ...
  \begin{mathpar}
    \inferrule { 
      e_l \rightsquigarrow^\star e 
      \\
      e_r \rightsquigarrow^\star e 
    } {
      e_l \cong e_r 
    } 
  \end{mathpar}
...
\begin{property} 
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \delta \cup \delta' \cup \delta^\dagger \satisfies e_f \hastype \tau^\dagger
      )
      )
      \\\\
      \iff
      ...
      \exists e_r \qua \delta \cup \delta' \cup \delta^\dagger \satisfies (e_a \J{,} e_r) \hastype \tau^\dagger 
      )
      )
      \implies
      \\\\
      ...
      \textbf{dom}(\delta') \cap \textbf{ftv}(\Delta) = \epsilon \up
      \delta \cup \delta' \cup \delta^\dagger \satisfies \Delta^\dagger \up
      \delta \cup \delta' \cup \delta^\dagger \satisfies (e_a\J{,}e_f\J{(}e_a\J{)}) \hastype \tau^\dagger
      )
      )
      )
      % \\\\
      ...
      % % (
      % % \forall e_a \qua
      % % \delta \cup \delta' \cup \delta^\dagger \satisfies (e_a \J{,BOT} ) \hastype \tau^\dagger \implies
      % % \delta \cup \delta' \cup \delta^\dagger \satisfies (\J{BOT,} e_f\J{(} e_a \J{)}) \hastype \tau^\dagger
      % % )
      % %%%%%
      % % \exists e_a \qua
      % % \delta \cup \delta' \cup \delta^\dagger \satisfies (e_a \J{,} e_f\J{(} e_a \J{)}) \hastype \tau^\dagger
...
\begin{theorem}
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \implies
      \exists e \qua e \J{.} l \rightsquigarrow e' \up \delta \satisfies e \hastype \tau
    }
...
\begin{theorem}
  \label{theorem:entry_type_elimination_progression}
  Entry Type Elimination Progression 
  \\
  \begin{mathpar}
    \inferrule {
      \delta \satisfies e \hastype \J{<}l\J{>} \tau
...
\implies 
\delta' \cup \delta  \satisfies (e_a\J{,loop(}e[\sigma]\J{)(} e_a \J{)}) \hastype \tau_\mu
$
by applying 
...
\implies 
\delta' \cup \delta  \satisfies (e_a\J{,loop(}e[\sigma]\J{)(} e_a \J{)}) \hastype \J{LFP[}\alpha_\mu\J{]}\tau_\mu
$
by ...
...
$
by applying 
Definition \ref{def:progression},
Definition \ref{def:multi_progression},
Definition \ref{def:expression_congruence},
and

...
\begin{definition} 
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \exists \Theta', \Delta' \qua \Theta, \Delta \entails \tau' \subtypes \tau \given \Theta', \Delta'  
      \\\\
      \TODO{change universal part to use polar sub to be comprehensive}
    } {
      \Theta, \Delta \entails \alpha \subtypes \tau \safe
    }
  \end{mathpar}
...
\begin{theorem}
  ...
  \TODO{need extension to overwrite previous keys; order matters; set union not sufficient}
\end{theorem}
...
\begin{theorem}
  \label{thm:polar_substitution_soundness}
  Polar Substitution Soundness 
  \\
  \begin{mathpar}
    \inferrule {
...
\begin{theorem}
  ...
  %   \delta \cup \delta \satisfies \Delta' 
  %   \implies 
  %   \delta' \cup \delta \satisfies \Delta[\alpha\slash\tau]^{+} \backslash \Delta 
  % )$ [IH]

  \item \I \N For $\delta'$, assume $(
    \delta' \cup \delta \satisfies \Delta'\ \alpha \J{<:} \tau
  )$ 
  \item \I\I \N Derive $(
    \delta' \cup \delta \satisfies \alpha \J{<:} \tau
  )$ [Thm. \ref{...}]
  ...
  \item \I \N For $\delta'$, Assume $(
    \delta' \cup \epsilon \satisfies \Delta\ \alpha \J{<:} \tau 
  )$ 
  \item \I\I \N Derive $(
    \delta' \cup \epsilon \satisfies\ \alpha \J{<:} \tau
  )$ 

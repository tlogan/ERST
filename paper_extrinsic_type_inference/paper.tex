...
\begin{theorem}
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \delta\ \alpha \slash \tau \satisfies \J{loop(}e\J{)} \hastype \tau
    } {
    }
  \end{mathpar}
\end{theorem}
...
(
\delta' \cup \delta \cup \delta^\dagger \satisfies \Delta \cup \Delta^\dagger \implies
\delta' \cup \delta \cup \delta^\dagger\ \alpha \slash \tau^\dagger \satisfies \J{loop(}e[\sigma] \J{)} \hastype \tau^\dagger
)
)
)$ (P3)

...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \TODO{make sure the fixed point constraints are pruned before flipping}

    \TODO{function type explosion should handle all pruning}
...
\begin{definition}
  ...
  \begin{mathpar}
    \inferrule {
      \TODO{update call to positive interp}
      \\\\
      \TODO{no need to ignore any variables in input to interp}
      \\\\
      \forall \Theta', \Delta'  \qua 
        \Theta' \backslash \Theta, \llbracket \textbf{ftv}(\Delta) \cup \Theta' \entails \Delta' \backslash \Delta, \alpha_l \J{->} \alpha_r \rrbracket^+ 
        \in \Pi
      \implies
...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \Theta' \backslash \Theta, \llbracket \dTheta \cup \Theta' \entails \Delta' \backslash \Delta, \tau_l \J{->} \tau_r \rrbracket^+ \in \Pi'
      \implies
...
\begin{property} 
  ...
  Duality Correspondence Soundness
  \\
  \begin{mathpar}
    \TODO{add some detail about the fixed point variables being TOP vs BOT or something}

    \TODO{the quantification of interpretion should be enough to assume or derive the fixed point types}

    \TODO{may need to assume that fixed point variables are the only non-skolem local variables}

    \TODO{make sure that the only constraints have the fixpoint variable subtyping a path type}
...
\begin{definition}
  ...
  \begin{mathpar}
    ...
    \TODO{this should only work if each input constraint is a fixed point subtyping a path type}
...
\begin{theorem}
  \label{theorem:subtyping_environment_union}
...
\begin{theorem}
  \label{theorem:entry_type_elimination}
...
\begin{theorem}
  \label{theorem:path_type_elimination}
...
\begin{theorem}
  \label{theorem:annotated_binding_introduction}
...
\begin{theorem}
  \label{theorem:subtyping_environment_interpretation_extension}
...
\begin{theorem}
  \label{theorem:subtyping_interpretation_extension}
...
\begin{theorem}
  \label{theorem:typing_environment_interpretation_extension}
...
\begin{theorem}
  \label{theorem:proof_typing_containment}
...
\begin{theorem}
  \label{theorem:proof_subtyping_containment}
...
\begin{theorem}
  \label{theorem:proof_subtyping_skolem_freshness}
...
\begin{theorem}
  \label{theorem:function_type_explosion_soundness}
...
\begin{theorem}
  \label{theorem:function_type_explosion_skolem_freshness}
...
\begin{theorem}
  \label{theorem:subtyping_factorization_soundness}
...
\begin{theorem}
  \label{theorem:expression_congruence_typing}
...
\begin{theorem}
  \label{theorem:least_fixed_point_type_elimination}
...
\begin{theorem}
  \label{theorem:right_congruence}
  Right Congruence 
  \\
  \begin{mathpar}
    \inferrule {
...
\begin{theorem}
  \label{theorem:path_type_elimination_loop}
...
\begin{theorem}
  \label{theorem:path_type_introduction}
...
by applying Theorem \ref{theorem:domain_extension} and rewriting with set arithmetic.
...
by applying
Theorem \ref{theorem:proof_typing_containment},
Theorem \ref{theorem:subtyping_environment_prefix_preservation},
and rewriting with set arithmetic.
We derive $\delta' \cup \delta_r \satisfies \Delta'$ 
by applying
Theorem \ref{theorem:proof_typing_skolem_freshness},
and
Theorem \ref{theorem:subtyping_environment_interpretation_contraction}.
...
and applying
Theorem \ref{theorem:typing_interpretation_extension}.
...
Theorem \ref{theorem:proof_typing_containment},
and 
Theorem \ref{theorem:typing_environment_interpretation_extension}.
...
$ (P1)
by applying Theorem \ref{theorem:proof_subtyping_soundness}.

Next, we derive $\textbf{dom}(\delta_a \cup \delta_b) = \Theta'' \backslash \Theta$ by applying
Theorem \ref{theorem:domain_extension} and rewriting with set arithmetic. 
...
by applying 
Theorem \ref{theorem:proof_subtyping_skolem_freshness}
and 
Theorem \ref{theorem:subtyping_environment_interpretation_contraction}.
...
by applying
Theorem \ref{theorem:domain_extension}
and
rewriting with set arithmetic.
...
$(\delta' \cup \delta_f \cup \delta_a \cup \delta_s \satisfies \Delta')$
by applying
Theorem \ref{theorem:proof_subtyping_containment},
Theorem \ref{theorem:proof_typing_containment},
and
Theorem \ref{theorem:subtyping_environment_prefix_preservation}.
Then, we derive
...
Theorem \ref{theorem:proof_subtyping_containment},
and
Theorem \ref{theorem:subtyping_interpretation_extension}.
...
by applying Theorem \ref{theorem:subsumption}.
...
by applying Theorem \ref{theorem:annotated_binding_introduction},
which simplifies to 
...
$ (P3)
by applying
Theorem \ref{theorem:function_type_explosion_soundness}
and
Theorem \ref{theorem:subtyping_environment_union}.
We derive
$(
\forall \Theta^\dagger, \Delta^\dagger, \tau^\dagger \qua 
(\Theta^\dagger, \Delta^\dagger, \tau^\dagger) \in \Pi_\nu \implies
...
$
by applying (P1), (P2), and Theorem \ref{theorem:subsumption}.
...
$
by Theorem \ref{theorem:path_type_elimination_loop}.
...
and
Theorem \ref{theorem:packaging_soundness}.
...
by applying 
Theorem \ref{theorem:least_fixed_point_type_elimination}.
...
by applying 
Theorem \ref{theorem:subtyping_factorization_soundness}.
Theorem \ref{theorem:subsumption},
Theorem \ref{theorem:entry_type_elimination},
and
Theorem \ref{theorem:right_congruence}.
...
by applying 
Theorem \ref{theorem:left_congruence}
and
Theorem \ref{theorem:subtyping_factorization_soundness}.
...
by applying 
Theorem \ref{theorem:expression_congruence_typing}.
...
by applying 
Theorem \ref{theorem:path_type_elimination_loop}

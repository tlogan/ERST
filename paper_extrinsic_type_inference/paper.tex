...
such that the positive interpretation $\llbracket ... \rrbracket^+$ constructs the strongest interpretation possible
ignoring variables $\vec{\alpha}_\ignore$ and $\vec{\alpha}$
and the negative interpretation $\llbracket ... \rrbracket^-$ constructs the weakest interpretation possible
ignoring variables $\vec{\alpha}_\ignore$ and $\vec{\alpha}$
.

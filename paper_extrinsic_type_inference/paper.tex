...
\begin{theorem}
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \exists \delta \qua \text{dom}(\delta) \cong \Theta' \backslash \Theta \up 
      (
      \forall \delta' \qua 
      \delta' \cup \delta \satisfies \Delta' \implies
      \delta' \cup \delta, \sigma \satisfies \Gamma \implies

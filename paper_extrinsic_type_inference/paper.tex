...
\begin{experiment}
  \label{experi:typability_comparison_polymorphic_instantiation}
  Typability Comparison (Polymorphic Instantiation) 
  \\
  \begin{center}
...
\begin{experiment}
  \label{experi:typability_comparison_polymorphic_generalization}
  Typability Comparison (Polymorphic Generalization) 
  \\
  \begin{center}
  \scriptsize
  % \setlength{\arrayrulewidth}{0.5mm}
...
\begin{experiment}
  \label{experi:typability_comparison_polymorphic_list}
  Typability Comparison (Polymorphic Lists) 
  \\
  \begin{center}
  \scriptsize
  % \setlength{\arrayrulewidth}{0.5mm}
...
\begin{experiment}
  \label{experi:typability_comparison_meta_application}
  Typability Comparison (Meta-application) 
  \\
  \begin{center}
  \scriptsize
  % \setlength{\arrayrulewidth}{0.5mm}
...
\begin{experiment}
  \label{experi:typability_comparison_eta_expansion}
  Typability Comparison (Eta Expansion) 
  \\
  \begin{center}
  \scriptsize
  % \setlength{\arrayrulewidth}{0.5mm}
...
\begin{experiment}
  \label{experi:typability_comparison_misc_freezeml}
  Typability Comparison (Misc from FreezeML Paper) 
  \\
  \begin{center}
  \scriptsize
  % \setlength{\arrayrulewidth}{0.5mm}
...
\begin{experiment}
  \label{experi:typability_comparison_misc_superf}
  Typability Comparison (Misc from SuperF Paper) 
  \\
  \begin{center}
  \scriptsize
  % \setlength{\arrayrulewidth}{0.5mm}

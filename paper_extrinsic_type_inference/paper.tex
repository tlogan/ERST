  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \forall \Theta'', \Delta''  \qua 
        \Theta'' \backslash \Theta', \llbracket \dTheta \cup \Theta' \entails \Delta'' \backslash \Delta', \alpha_l \J{->} \alpha_r \rrbracket^+ 
        \in \Pi_\nu
      \implies
      ...
      \\
      \textbf{pack}^-(\dTheta\ \alpha_\mu \entails \Pi_\mu) = \tau_\mu
      \\\\
...
\begin{property} 
  ...
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta, \Gamma \entails \tau_l \subtypes \tau_r \given \Theta', \Delta'
    } {
      \exists \delta .\ 
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails \tau_l \subtypes \tau_r \given \Theta', \Delta'}
  \\
  \begin{mathpar}
    \inferrule {
    } {
      \Theta, \Delta, \Gamma \entails \tau \subtypes \tau \given \Theta, \Delta 
    }
  \end{mathpar}
\end{definition}
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails \kappa_l \subtypes \kappa_r \given \Theta', \Delta'}
  \\
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta, \Gamma \entails 
      \tau_l \subtypes \tau_r
      \given \Theta', \Delta' 
    } {
      \Theta, \Delta, \Gamma \entails 
    ...
    \inferrule {
      \Theta, \Delta, \Gamma \entails \tau_{x} \subtypes \tau_{p} \given \Theta', \Delta'
      \\
      \Theta', \Delta', \Gamma \entails \tau_{q} \subtypes \tau_{y} \given \Theta'', \Delta'' 
    } {
      \Theta, \Delta, \Gamma \entails 
      \tau_{p} \J{->} \tau_{q} 
      \subtypes 
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails \phi \subtypes \tau \given \Theta', \Delta'}
  \\
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta, \Gamma \entails
    ...
    \inferrule {
      ...
      \\
      \Theta_l \cap \textbf{ftv}(\Gamma) = \emptyset 
      \\
      \Theta_l \cap \textbf{ftv}(\tau_r) = \emptyset
      \\\\
      \Theta, \Delta, \Gamma \entails \Delta_l \given \Theta', \Delta' \unique
      \\
      \Theta' \cup \Theta_l, \Delta', \Gamma \entails
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails \tau \subtypes \psi \given \Theta', \Delta'}
  \\
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta, \Gamma \entails
    ...
    \inferrule {
      ...
      \\
      \Theta_r \cap \textbf{ftv}(\Gamma)
      \\
      \Theta_r \cap \textbf{ftv}(\tau_l)
      \\\\
      \Theta, \Delta \given \Delta_r  \given \Theta', \Delta' \unique
      \\
      \Theta' \cup \Theta_r, \Delta', \Gamma \entails \tau_l \subtypes \tau_r \given \Theta'', \Delta'' 
    } {
      \Theta, \Delta, \Gamma \entails \tau_l \subtypes \J{ALL[}\Theta_r\J{]}\Delta_r\ \tau_r \given \Theta'', \Delta''
    }
  \end{mathpar}
\end{definition}
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails \alpha \subtypes \tau \given \Theta', \Delta'} 
  \\
  \begin{mathpar}
    \inferrule {
      \alpha \notin \Theta
      ...
      \\\\
      \Theta, \Delta, \Gamma \entails \Delta_\closed \safe
      \\
      \Theta, \Delta \cup \Delta_\closed, \Gamma \entails \Delta_\open \given \Theta', \Delta'
    } {
      \Theta, \Delta, \Gamma \entails \alpha \subtypes \tau \given \Theta', \Delta'\ \alpha\J{<:}\tau
    }
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails \tau \subtypes \alpha \given \Theta', \Delta'}
  \\
  \begin{mathpar}
    \inferrule {
      \alpha \notin \Theta
      ...
      \Theta, \Delta, \Gamma \entails \Delta_\closed \safe
      \\
      \Theta, \Delta \cup \Delta_\closed, \Gamma \entails 
    ...
    \inferrule {
      \alpha \in \Theta 
      \\
      \Theta, \Delta, \Gamma \entails \tau_l \subtypes \alpha \safe
      \\
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails \J{LFP[}\alpha\J{]}\tau_l \subtypes \tau_r \given \Theta', \Delta'}
  \\
  \begin{mathpar}
    \inferrule {
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails\tau \subtypes \rho \typdiff \eta \given \Theta', \Delta'}
  \\
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta, \Gamma \entails 
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails \tau_l \subtypes \J{LFP[} \alpha \J{]}\tau_r \given \Theta', \Delta'}
  \\
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta, \Gamma \entails \tau_l \circlearrowleft \J{LFP[} \alpha \J{]} \tau_r
      \\
      \Theta, \Delta, \Gamma \entails
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails \rho \typdiff \eta \subtypes \tau \given \Theta', \Delta'}
  \\
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta, \Gamma \entails 
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails \tau \subtypes \phi \given \Theta', \Delta'}
  \\
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta, \Gamma \entails \tau \subtypes \tau_{l} \given \Theta', \Delta' 
    } {
      \Theta, \Delta, \Gamma \entails \tau \subtypes \tau_{l}\J{|}\tau_{r} \given \Theta', \Delta' 
    }

    \inferrule {
      \Theta, \Delta, \Gamma \entails \tau \subtypes \tau_{r} \given \Theta', \Delta' 
    } {
      \Theta, \Delta, \Gamma \entails \tau \subtypes \tau_{l}\J{|}\tau_{r} \given \Theta', \Delta' 
    }
    ...
    \inferrule {
      \Theta, \Delta, \Gamma \entails \tau_l \subtypes \tau_r \given \Theta', \Delta'
      \\
      \Theta', \Delta', \Gamma \entails \Delta_r \given \Theta'', \Delta'' 
    } {
      \Theta, \Delta, \Gamma \entails 
      \tau_l
      \subtypes 
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails \psi \subtypes \tau \given \Theta', \Delta'}
  \\
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta, \Gamma \entails \tau_{l} \subtypes \tau \given \Theta', \Delta'
    } {
      \Theta, \Delta, \Gamma \entails \tau_{l}\J{\&}\tau_{r}  \subtypes \tau \given \Theta', \Delta' 
    }
    ...
    \inferrule {
      \Theta, \Delta, \Gamma \entails \tau_l \subtypes \tau_r \given \Theta', \Delta'
      \\
      \Theta', \Delta', \Gamma \entails \Delta_l \given \Theta'', \Delta'' 
    } {
      \Theta, \Delta, \Gamma \entails 
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails \alpha \subtypes \tau \safe}
  \\
  \begin{mathpar}
    \inferrule {
      ...
      \down 
      (\exists \Theta', \Delta' \qua \Theta, \Delta, \Gamma \entails \tau' \subtypes \tau \given \Theta', \Delta') 
      )
      \\\\
      ...
      \Theta, \Delta, \Gamma \entails \alpha \subtypes \tau \safe
    }
  \end{mathpar}
\end{definition}
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails \tau \subtypes \alpha \safe}
  \\
  \begin{mathpar}
    \inferrule {
      ...
      \Theta, \Delta, \Gamma \entails \tau \subtypes \alpha \safe
    }
  \end{mathpar}
\end{definition}
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails \Delta_q \given \Theta', \Delta'}
  \\
  \begin{mathpar}
    \inferrule {
    } {
      \Theta, \Delta, \Gamma \entails \epsilon \given \Theta', \Delta'
    }

    \inferrule {
      \Theta, \Delta, \Gamma \entails \tau_l \J{<:} \tau_r \given \Theta', \Delta'
      \\
      \Theta', \Delta', \Gamma \entails \tau_l \J{<:} \tau_r \given \Theta'', \Delta''
    } {
      \Theta, \Delta, \Gamma \entails \Delta_q\ \tau_l \J{<:} \tau_r \given \Theta'', \Delta''
    }
  \end{mathpar}
\end{definition}
...
\begin{definition} 
  ...
  \hfill
  \boxed{\Theta, \Delta, \Gamma \entails \Delta_q \given \Theta', \Delta' \unique}
  \\
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta, \Gamma \entails \Delta_q \given \Theta', \Delta'
      \\\\
      \forall \Theta'', \Delta'' \qua 
      \Theta, \Delta, \Gamma \entails
      \Delta_q \given \Theta', \Delta' \implies (\Theta'', \Delta'') = (\Theta', \Delta')
    } {
      \Theta, \Delta, \Gamma \entails \Delta_q \given \Theta', \Delta' \unique
    }
  \end{mathpar}
\end{definition}
...
\begin{theorem}
  \label{theorem:proof_typing_typing_environment_constrained}
  Proof Typing Typing Environment Constrained 
  \\
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta, \Gamma \entails e \hastype \tau \given \Theta', \Delta'
...
\begin{theorem}
  \label{theorem:proof_typing_variables_constrained}
  Proof Typing Variables Constrained 
  \\
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta, \Gamma \entails e \hastype \tau \given \Theta', \Delta'
...
\begin{theorem}
  \label{theorem:proof_subtyping_variables_constrained}
  Proof Subtyping Variables Constrained 
  \\
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta, \Gamma \entails \tau \subtypes \tau' \given \Theta', \Delta'
...
\begin{theorem}
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \up 
      \Theta' \backslash \Theta \cap \textbf{ftv}(\Gamma) = \emptyset
    }
  \end{mathpar}
\end{theorem}
\hfill
...
\begin{theorem}
  \label{theorem:proof_typing_subset}
  Proof Typing Subset 
  \\
  \begin{mathpar}
    \inferrule {
...
\begin{theorem}
  \label{theorem:proof_subtyping_subset}
  Proof Subtyping Subset 
  \\
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta \entails \tau \subtypes \tau' \given \Theta', \Delta'
...
by applying
Theorem \ref{theorem:proof_typing_subset},
...
by applying 
Theorem \ref{theorem:proof_typing_skolem_freshness}
Theorem \ref{theorem:proof_typing_variables_constrained},
...
\TODO{modify rules to have Delta contain all variables adding (BOT <: X) or (X <: TOP) to constraints}
...
we derive three typing interpretations $\delta_f$, $\delta_a$, $\delta_s$,
such that 
$\text{dom}(\delta_f) = \Theta' \backslash \Theta$, 
$\text{dom}(\delta_a) = \Theta'' \backslash \Theta'$, 
and
$\text{dom}(\delta_s) = \Theta''' \backslash \Theta''$,
by applying the induction hypothesis twice and Theorem \ref{theorem:proof_subtyping_soundness}.
We construct the typing interpretation $\delta$, such that $\delta = \delta_f \cup \delta_a \cup \delta_s$,
which gives us $\text{dom}(\delta) = \Theta''' \backslash \Theta$ by rewriting.

Next, we introduce an arbitrary typing environment $\delta$,
and we assume $\delta' \cup \delta \satisfies \Delta''$ and $\delta', \sigma \satisfies \Gamma$.
We derive $\delta' \cup \delta \satisfies e_f[\sigma] \hastype \tau_f$,
by instantiating the first applied induction hypothesis with $\delta'$,
and applying 
Theorem \ref{theorem:subtyping_environment_prefix_preservation},
Theorem \ref{theorem:proof_subtyping_skolem_freshness},
Theorem \ref{theorem:proof_subtyping_subset},
Theorem \ref{theorem:proof_typing_skolem_freshness},
Theorem \ref{theorem:subtyping_environment_interpretation_contraction},
and 
Theorem \ref{theorem:typing_interpretation_extension}.
We derive $\delta' \cup \delta \satisfies e_a[\sigma] \hastype \tau_a$,
by instantiating the second applied induction hypothesis with $\delta' \cup \delta_a$,
and applying Theorem \ref{theorem:subtyping_environment_prefix_preservation},
Theorem \ref{theorem:proof_subtyping_skolem_freshness},
Theorem \ref{theorem:subtyping_environment_interpretation_contraction},
Theorem \ref{theorem:proof_typing_skolem_freshness},
Theorem \ref{theorem:typing_environment_interpretation_extension},
and 
Theorem \ref{theorem:typing_interpretation_extension}.
We derive $\delta' \cup \delta \satisfies \tau_f \subtypes \tau_a \J{->} \alpha$ by 
instantiating the applied Theorem \ref{theorem:proof_subtyping_soundness} 
with $\delta' \cup \delta_f \cup \delta_a$,
and applying 
Theorem \ref{theorem:proof_typing_skolem_freshness},
Theorem \ref{theorem:proof_typing_subset},
and
...
Then, we derive $\delta' \cup \delta \satisfies e_f[\sigma] \hastype \tau_a \J{->} \alpha$
by applying Theorem \ref{theorem:subsumption}.
Thus, we have $\delta' \cup \delta \satisfies e_f[\sigma]\J{(}e_a[\sigma]\J{)} \alpha$
by Theorem \ref{theorem:path_type_elimination},
which simplifies to $\delta' \cup \delta \satisfies e_f\J{(}e_a\J{)}[\sigma] \hastype \alpha$,
by Definition \ref{def:substitution}.

\pc
For $\Theta, \Delta, \Gamma \entails \J{let } x \J{:} \tau_a \J{ = } e \J{ in } e' \hastype \tau' \given \Theta''', \Delta'''$,
we derive a typing interpretation $\delta_a$, such that $\textbf{dom}(\delta_a) = \Theta' \backslash \Theta$
by applying the induction hypothesis to the Proof Typing of $e \hastype \tau$.
We derive a typing interpretation $\delta_b$, such that $\textbf{dom}(\delta_b) = \Theta'' \backslash \Theta'$
by applying Theorem \ref{theorem:proof_subtyping_soundness} to the Proof Subtyping of $\tau \subtypes \tau_a$.
We derive a typing interpretation $\delta_c$, such that $\textbf{dom}(\delta_c) = \Theta''' \backslash \Theta''$
by applying the induction hypothesis to the Proof Typing of $e' \hastype \tau'$.
We construct the typing interpretation $\delta$, such that $\delta = \delta_a \cup \delta_b \cup \delta_c$,
which gives us $\text{dom}(\delta) = \Theta''' \backslash \Theta$ by rewriting.
...
We derive $\delta' \cup \delta \satisfies \tau \subtypes \tau_a$,
by instantiating the first applied induction hypothesis with $\delta' \cup \delta_a$,
and applying 
Theorem \ref{theorem:subtyping_environment_prefix_preservation},
Theorem \ref{theorem:proof_typing_skolem_freshness},
Theorem \ref{theorem:subtyping_environment_interpretation_contraction},
...
We derive $\delta' \cup \delta, \sigma\ x \slash e[\sigma] \hastype \tau_a$
by applying Theorem \ref{theorem:subsumption}.
We derive $\delta' \cup \delta, \sigma\ x \slash e[\sigma] \satisfies \Gamma\ x \hastype \tau$
by applying Definition \ref{def:model_sequence_typing} (Model Sequence Typing).
We derive $\delta' \cup \delta \satisfies e'[\sigma\ x \slash e[\sigma]] \hastype \tau'$,
by instantiating the first applied induction hypothesis with the typing interpretation $\delta' \cup \delta_a \cup \delta_b$,
and the value interpretation $\sigma\ x \slash e[\sigma]$,
and applying
Theorem \ref{theorem:proof_subtyping_skolem_freshness},
Theorem \ref{theorem:proof_subtyping_subset},
Theorem \ref{theorem:proof_typing_skolem_freshness},
and 
Theorem \ref{theorem:typing_interpretation_extension}.
We simplify to $\delta' \cup \delta \satisfies e'[\sigma][x \slash e[\sigma]] \hastype \tau'$,

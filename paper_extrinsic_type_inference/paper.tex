...
\begin{definition} 
  ...
  \begin{array}[t]{r@{}c@{}lcl}
      ...
      \llbracket \Theta, \Delta \entails \J{EXI[}\Theta_q\ \Delta_q \J{]} \tau \rrbracket^\pm 
      &\ =\ & 
      \J{EXI[}\Theta_q\ \llbracket \Theta \cup \Theta_q, \Delta \entails \Delta_q \rrbracket^\pm \J{]}
      \llbracket \Theta \cup \Theta_q, \Delta \entails \tau \rrbracket^{\pm}

      \\

      \llbracket \Theta, \Delta \entails \J{ALL[}\Theta_q\ \Delta_q \J{]} \tau \rrbracket^\pm 
      &\ =\ & 
      \J{ALL[}\Theta_q\ \llbracket \Theta \cup \Theta_q, \Delta \entails \Delta_q \rrbracket^\pm \J{]}
      \llbracket \Theta \cup \Theta_q, \Delta \entails \tau \rrbracket^{\pm}
...
\begin{theorem}
  \label{thm:typing_environment_soundness}
...
% \begin{theorem}
%   \label{thm:entry_type_introdcution}
...
% \Theta, \Delta, \Gamma \entails \J{let } x \J{:} \tau \J{ = } e \J{ in } e' \hastype \tau' \given \Theta''', \Delta'''
...
\begin{theorem}
  \label{thm:expression_congruence_typing}
  Expression Congruence Typing 
  \\
  \begin{mathpar}
    \inferrule {
      e_l \cong e_r
...
\begin{theorem}
  ...
  \item \I \N For $\delta'$, assume $(\delta' \cup \delta \satisfies \Delta')$
  \item \I\I \N Derive $(\delta' \cup \delta \satisfies \tau_l \subtypes \tau_r)$ [P0]

...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \Theta, \Delta \entails \tau_l \subtypes \J{ALL[}\Theta_r\J{]}\Delta_r\ \tau_r \given \Theta'', \Delta''
    }
  \end{mathpar}
\end{definition}
...
\begin{theorem}
  ...
  Subtyping Environment Interpretation Extension 
  \\
  \begin{mathpar}
    \inferrule {
      \delta \satisfies \Delta
...
\begin{theorem}
  ...
  Subtyping Interpretation Extension 
  \\
  \begin{mathpar}
    \inferrule {
      \delta \satisfies \tau \subtypes \tau' 
...
\begin{theorem}
  ...
  Typing Environment Interpretation Extension 
  \\
  \begin{mathpar}
    \inferrule {
      \delta, \sigma \satisfies \Gamma 
...
\begin{theorem}
  ...
  \item \I \N Derive $(
    \Theta, \Delta \entails \Delta_l \given \Theta', \Delta'
  )$ [Def. \ref{def:unique_proof_subtyping_environment}]
  \item \I \N And $(
    \forall \Theta'', \Delta'' \qua 
    \Theta, \Delta \entails
    \Delta_l \given \Theta', \Delta' \implies (\Theta'', \Delta'') = (\Theta', \Delta')
  )$ [Def. \ref{def:unique_proof_subtyping_environment}]
  ...
  \item \I \N And P0: $(
    ...
    \delta \cup \delta_0 \satisfies \Delta' 
    \implies 
    \delta \cup \delta_0 \satisfies \Delta_q
  )$ [Thm. \ref{thm:proof_subtyping_environment_soundness}]

  \item \I \N Let $\delta_1$ be, such that $(
    \textbf{dom}(\delta_1) \subseteq \Theta'' \backslash (\Theta' \cup \Theta_l)
  )$ [Thm. \ref{thm:proof_subtyping_soundness}]
  \item \I \N And P1: $(
    \forall \delta' \qua 
    \delta \cup \delta_1 \satisfies \Delta' 
    \implies 
  ...
  \item \I \N Derive $(
    \textbf{dom}(\delta_0 \cup \delta_1) \subseteq \Theta'' \backslash \Theta_l \backslash \Theta
  )$
  \item \I \N Derive $(
  ...
  \item \I\I \N Derive $(\delta' \cup \delta_0 \satisfies \Delta')$
    [Thm. \ref{thm:proof_subtyping_skolem_freshness}, Thm. \ref{thm:subtyping_environment_interpretation_contraction}]
  \item \I\I \N Derive $(\delta' \cup \delta_0 \satisfies \Delta_l)$
    [P0]
  \item \I\I \N Derive $(\delta' \cup \delta_0 \cup \delta_1 \satisfies \Delta_l)$
  ...
  \item \I \N \TODO{why is uniqueness of subtyping enironment necessary for soundness?}

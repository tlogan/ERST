...
\begin{property} 
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \\\\
      (
      \forall \Theta_\mu, \Delta_\mu, \tau_\mu \qua
      (\Theta_\mu,\Delta_\mu, \tau_\mu) \in \Pi_\mu \implies
      \\\\
      (
      \forall \delta_\mu \qua \textbf{dom}(\delta_\mu) \cong \Theta_\mu \implies
      \\\\
      (
      \exists \delta', e_a \qua
      \textbf{dom}(\delta') \cap \textbf{ftv}(\Delta) = \epsilon \up 
      \delta \cup \delta' \cup \delta_\mu \satisfies \Delta_\mu \up
      \delta \cup \delta' \cup \delta_\mu \satisfies (e_a \J{,} e_f\J{(} e_a \J{)}) \hastype \tau_\mu
      )
      )
      )
      )
...
\begin{theorem}
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \\\\
      (
      \forall \delta \qua \textbf{dom}(\delta) \cong \Theta^\dagger \backslash \dTheta \implies
      (
      \exists \delta' \qua 
      \delta' \cup \delta \satisfies \Delta \cup \Delta^\dagger \up
      \delta' \cup \delta \satisfies e[\sigma] \hastype \tau^\dagger
      )
      ) 
      \\\\
...
We derive an expression $e_a$, such that ....

We derive
$... \satisfies \J{loop(}e[\sigma]\J{)(} e_a \J{)} \hastype \tau^\dagger$
by ....

We derive
$... \satisfies \J{loop(}e[\sigma]\J{)(} e_a \J{)} \hastype \tau_\mu$
by ....

We derive
$... \satisfies \J{loop(}e[\sigma]\J{)(} e_a \J{)} \hastype \J{LFP[} \alpha_\mu \J{]}\tau_\mu$
by ....

We derive
$... \satisfies \J{loop(}e[\sigma]\J{)(} e_a \J{)} \hastype \tau_l \J{\&} \tau_r$
by ....

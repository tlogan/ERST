...
(
\forall \delta' \qua
\delta' \cup \delta^\dagger \satisfies \Delta' \cup \Delta^\dagger \implies
...
\exists \delta^\dagger \qua \textbf{dom}(\delta^\dagger) \cong \Theta^\dagger \up 
(
\forall \delta', \delta'' \qua
\delta' \cup \delta'' \cup \delta^\dagger \satisfies \Delta' \cup \Delta^\dagger \implies
\delta' \cup \delta'' \cup \delta^\dagger \satisfies \tau \subtypes \alpha \J{->} \tau^\dagger
)
)
$ (P...)
by applying
...
\TODO{need a way to stay general for new constraints but be specific for inherited constraints}

\TODO{perhaps the duality lemmas need to generalize over inherited constraints}
...
% (
% \delta' \cup \delta \cup \delta^\dagger \satisfies \Delta \cup \Delta^\dagger \implies
% \delta' \cup \delta \cup \delta^\dagger \satisfies e[\sigma] \hastype \alpha \J{->} \tau^\dagger
% )
% )
% )$ (P2) by applying 
% Theorem \ref{theorem:function_type_explosion_skolem_freshness},
% Theorem \ref{theorem:proof_typing_containment},
% Theorem \ref{theorem:typing_interpretation_extension},
% Theorem \ref{theorem:subsumption}
% to instances of (P1).
...
% (
% \delta' \cup \delta \cup \delta^\dagger \satisfies \Delta \cup \Delta^\dagger \implies
% \delta' \cup \delta \cup \delta^\dagger \satisfies \J{loop(}e[\sigma] \J{)} \hastype \tau^\dagger
% )
% )
% )$ (P3)
% by applying Theorem \ref{theorem:path_type_elimination_loop}
% to instances of (P2).
% We derive 
% $(
% \forall \Theta^\dagger, \Delta^\dagger, \tau^\dagger \qua 
...
% )
% )$ (P4)
% by applying Theorem \ref{theorem:subtyping_environment_union}.
*********************************************************************

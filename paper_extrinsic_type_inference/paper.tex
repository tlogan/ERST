...
Then, we derive $\delta' \cup \cup \delta_f \cup \delta_a \cup \delta_s \satisfies e_f[\sigma] \hastype \tau_a \J{->} \alpha$
by applying 
Theorem \ref{theorem:subsumption}.
Thus, we have $\delta' \cup \cup \delta_f \cup \delta_a \cup \delta_s \satisfies e_f[\sigma]\J{(}e_a[\sigma]\J{)} \alpha$

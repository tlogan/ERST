...
\begin{property}
  ...
  \begin{mathpar}
    \inferrule { 
      \llbracket \vec{\alpha}_\ignore, \vec{\alpha}_\closed \entails \Delta, \tau \rrbracket^+ = (\Delta', \tau')
      \\
...
\noindent
Type interpretation $\llbracket \vec{\alpha}_\ignore, \vec{\alpha}_\closed \entails \Delta, \tau \rrbracket^\pm = (\Delta', \tau')$
looks for substitutions of variable in the input type $\tau$ that satisfy the subtyping constraints $\Delta$,

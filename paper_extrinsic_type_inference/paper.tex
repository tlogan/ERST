...
Consider the function \mspan{\J{talky}}, which completes a simple English phrase.
...
\noindent
The notation \mspan{\textbf{Bool}} and \mspan{\textbf{List}(\J{X})} are meta-language terms representing types.
...
or bindings with type annotations, $\J{def}\ x\ \J{:}\ \tau\ \J{=}\ e\ \J{in}\ e$.
...
A binding with type annotation $\J{def}\ x\ \J{:}\ \tau\ \J{=}\ e\ \J{in}\ e$ allows the programmer 
...
\begin{definition} 
  ...
  \begin{align*}
      ...
      \end{array}
      \\
      \llbracket \J{def}\ x\ \J{=}\ e\ \J{in}\ e' \rrbracket^\square &= (\J{?}x \J{=>} e')\J{(}e\J{)}
  \end{align*}
...
unannotated bindings $\J{def}\ x\ \J{=}\ e\ \J{in}\ e$, data flow $e\ \J{|>}\ e$,

...
such that a given function inhabits all interpretations of every path type colony
if and only if 
there's an argument paired with the function applied to it that inhabits an interpretation
of at least one of the pair type colonies.
...
such that 
a given function inhabits all interpretations of 
every type constrained by the environment's path type upper bounds
if and only if 
there's an argument paired with the function applied to it that inhabits an interpretation
of at least one type constrained by the environment's pair type lower bounds.

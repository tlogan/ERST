...
of code reusability, we leave such relational reasoning of inductive and co-recursive types out of
the type system. 
...
$(e \hastype \tau)$ 
if the generated constraints $\Delta'$ and input typing constraints $\Gamma$ hold,
in terms of Model Typing (Def. \ref{def:model_typing}). 
...
to require that the constraints generated by Proof Typing hold. 
...
\TODO{move sub definitions to appendix}
...
\TODO{leave duality correspondence property to the appendix}
...
\TODO{move packing details into appendix by packing definition}
...
\TODO{edit here: follow-up on proof subtyping}

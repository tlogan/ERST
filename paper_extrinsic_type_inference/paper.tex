...
We construction the typing interpretation $\delta$, such that $\delta = \delta_f \cup \delta_a \cup \delta_s$,
...
We derive $\delta' \cup \delta \satisfies e_f[\sigma] \hastype \tau_a \J{->} \alpha$

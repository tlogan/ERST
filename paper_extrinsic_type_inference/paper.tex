...
\begin{property} 
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \iff
      \\\\
      (\forall e_a \qua \satisfies e_f\J{(} e_a \J{)} \hastype \J{TOP}
      \implies
      (
      \exists \Theta_\mu, \Delta_\mu, \tau_\mu \qua
      (\Theta_\mu,\Delta_\mu, \tau_\mu) \in \Pi_\mu \up
      \\\\
      (
      \forall \delta_\mu \qua \textbf{dom}(\delta_\mu) \cong \Theta_\mu \implies
      (
      \exists \delta, \tau_\mu' \qua
      \delta \cup \delta_\mu\ \alpha_\mu \slash \tau_\mu' \satisfies \Delta_\mu \up
      \delta \cup \delta_\mu\ \alpha_\mu \slash \tau_\mu \satisfies (e_a \J{,} e_f\J{(} e_a \J{)}) \hastype \tau_\mu
      )
      )
      )
      )

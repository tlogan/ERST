...
\TODO{add no free var check on Omega}

\TODO{consider ways too relax bound variables in Omega requirement}
...
Proof Subtyping leverages Skolem Variable Elimination 
$(\Theta, \Delta \entails \alpha \subtypes \tau \safe)$
(Def. \ref{def:skolem_variable_elimination}),

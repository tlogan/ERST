...
\begin{definition}
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \\
      \Delta \entails \vec{\alpha}_\ignore \cup \vec{\alpha} \backslash \vec{\alpha}_p \pitchfork \Delta' 
      \\
      \vec{\alpha}_\ignore, \vec{\alpha}, \Delta' \entails \Delta_o \wr \Delta_i 
      \\\\
...
\begin{definition}
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \\
      \Delta \entails \vec{\alpha} \pitchfork \Delta'
    } {
      \Delta \ \tau_l<:\tau_r \entails \vec{\alpha} \pitchfork \Delta' \J{;} \tau_l \J{<:} \tau_r
    }
    ...
    \inferrule {
      ...
      \Delta \J{;} \tau_l \J{<:} \tau_r \entails \vec{\alpha} \pitchfork \Delta'
    }
  \end{mathpar}
\end{definition}
...
\begin{definition}
  Partition
  \hfill
  \boxed{\vec{\alpha}_\ignore, \vec{\alpha}, \Delta \entails \Delta_o \wr \Delta_i}
  \\
  \begin{mathpar}
    \inferrule {
    } {
      \vec{\alpha}, \epsilon \entails \epsilon \wr \epsilon 
    }

    \inferrule {
      \TODO{...}
      \\\\
      \text{FTV}(\tau_l) \cup \text{FTV}(\tau_r) = \vec{\alpha}_q
      \\
      \alpha \in \vec{\alpha}_q \\ \alpha \notin \vec{\alpha}
      \\
      \vec{\alpha}, \Delta \entails \Delta_o \wr \Delta_i 
    } {
      \vec{\alpha}_\ignore, \vec{\alpha}, \Delta \J{;} \tau_l \J{<:}\tau_r \entails \Delta_o \wr \Delta_i \J{;} \tau_l \J{<:} \tau_r
    }

    \inferrule {
      \text{FTV}(\tau_l) \cup \text{FTV}(\tau_r) = \vec{\alpha}_q
      \\
      \forall \alpha .\ \alpha \in \vec{\alpha}_q \implies \alpha \in \vec{\alpha}
      \\
      \vec{\alpha}, \Delta \entails \Delta_o \wr \Delta_i 
    } {
      \vec{\alpha}_\ignore, \vec{\alpha}, \Delta \J{;} \tau_l \J{<:}\tau_r \entails \Delta_o \J{;} \tau_l \J{<:} \tau_r \wr \Delta_i 
    }

...
\noindent
A value map assigns variables to expressions.
Progression relies on interpretation maps to collect
values that are relevant from pattern matching \ms{p \equiv v \entails \sigma},
...
\TODO{note how universal disallows vacuous non-empty types, which would allow erroneous expressions to have a type}

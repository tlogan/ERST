...
\begin{property} 
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \\\\
      (
      \exists e_a, \Theta_\mu, \Delta_\mu, \tau_\mu \qua
      ...
      \delta\ \alpha_\mu \slash \tau_\mu' \cup \delta_\mu \satisfies \Delta_\mu \up
...
\begin{theorem}
  ...
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta, \Gamma \entails \tau \circledast \alpha \rightarrow \Pi 
    } {
...
and
$(\exists \alpha  \qua \J{LFP[} \alpha_\mu \J{]}\tau_\mu \subtypes \J{TOP} \J{*} \alpha \factorsinto \tau_r \subtypes \alpha)$
by Definition \ref{def:proof_typing}.

\TODO{induction won't work since the output subtyping environment is the input, and not bigger or equal to the output of the subproblems }
*********************************************************************

...
\begin{definition}
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \\
      \textbf{ftv}(\Delta) \entails \Pi \dashrightarrow \Pi' 
    } {
...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \Theta' \backslash \Theta, 
      \Delta' \backslash \Delta, \llbracket 
      \textbf{ftv}(\Delta) \cup \textbf{ftv}(\Gamma) \cup \Theta' \entails \tau_l \J{->} \tau_r \rrbracket^+ \in \Pi'
      \implies
      ...
      \text{capture}(\rho) = \eta
      \\
      \textbf{ftv}(\Delta) \cup \textbf{ftv}(\Gamma) \entails \Pi' \dashrightarrow \Pi'' 
    } {
...
\begin{definition}
  Multi Subtyping Environment Filter 
  \hfill
  \boxed{\dTheta \entails \Pi \dashrightarrow \Pi'}
  \\
  \begin{mathpar}
    \inferrule {
    } {
      \dTheta \entails \epsilon \dashrightarrow \epsilon 
    }

    \inferrule {
      \dTheta \entails \Pi \dashrightarrow \Pi'
      \\
      \dTheta \cup \Theta \entails \Delta \dashrightarrow \Delta'
    } {
      \dTheta \entails \Pi\ (\Theta, \Delta, \tau) \dashrightarrow \Pi'\ (\Theta, \Delta', \tau)
    }
  \end{mathpar}
\end{definition}

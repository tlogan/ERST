...
\begin{semantics}\boxed{e\ \textbf{wellformed}}
  \label{semantics:expression_wellformed}
  \begin{mathpar}
    \inferrule { 
      e = v
    } {
...
\begin{theorem}(Soundness of typing)
  ...
  \item \I $\textbf{let } \Omega\ \Gamma' \ \tau' \textbf{ s.t. } \Omega, \Gamma' \satisfies e \hastype \tau'$ by \D{Lemma \ref{lemma:proof_typing_soundness}}
  \item \I $\Omega, \Sigma \satisfies \Gamma'$ by ...
  \item \I $e[\Sigma] \textbf{ wellformed} $ by lemma \ref{lemma:model_typing_soundness}
  \item \I $e[\Sigma] = e$ by ...
...
\begin{lemma}(Soundness of proof typing)
  \label{lemma:proof_typing_soundness}
  \begin{mathpar}
    \inferrule { 
      \Gamma \entails e \hastype \tau \given Z  
    } {
...
\begin{lemma}(Subsumption of model typing)
  \label{lemma:subsumption_model_typing}
  \begin{mathpar}
    \inferrule { 
  ...
  $
  \item \Z $\forall e' .\ \Omega, \Gamma \satisfies e' : \tau_l \implies \Omega, \Gamma \satisfies e' : \tau_r$ by inversion on $\Omega, \Gamma \satisfies \tau_l <: \tau_r$
...
\begin{lemma}(Elimination of implication of model typing)
  \label{lemma:model_typing_implication_elimination}
  \begin{mathpar}
    \inferrule { 
  ...
  $
  \item \Z $
    \Omega \sqcup \Omega', \Gamma \sqcup \Gamma' \satisfies p \hastype \tau_l
    \I
    \Omega \sqcup \Omega', \Gamma \sqcup \Gamma'  \satisfies e \hastype \tau_r
  $
  \item \Z $
    \textbf{for} \ F \ p \ e \ \Omega' \ \Gamma' \  
  $
  % \item \Z\Z $\textbf{case}\ F = \epsilon$
  % \item \Z\Z\Z \TODO{...} 
  % \item \Z\Z\Z $\textbf{for}\ e'$
  % \item \Z\Z\Z\Z $\neg \epsilon\code{(}e_1\code{)} \rightsquigarrow e'$ by definition 
  % \item \Z\Z\Z\Z $\neg F\code{(}e_1\code{)} \rightsquigarrow e'$ by substitution 
  % \item \Z\Z\Z $\forall e' .\ \neg F\code{(}e_1\code{)} \rightsquigarrow e'$ by summarization 
  % \item \Z\Z\Z \TODO{...} 
  % \item \Z\Z $\textbf{case}\ \Omega, \Gamma \satisfies F \hastype \tau_l \code{->} \tau_r$
  % \item \Z\Z\Z $\Omega, \Gamma \satisfies F\code{(}e_1\code{)} \hastype \tau_r$ by induction hypothesis 
  % \item \Z\Z\Z \TODO{...} 
  % \item \Z\Z $\Omega, \Gamma \satisfies e_0\code{(}e_1\code{)} \hastype \tau_r$ by cases on $F = \epsilon \lor \Omega, \Gamma \satisfies F \hastype \tau_l \code{->} \tau_r$

  \item \Z\Z $\textbf{let } \Sigma \textbf{ s.t. } \Omega, \Sigma \satisfies \Gamma $ by lemma \ref{lemma:model_typing_assignability} 
  \item \Z\Z $e_0[\Sigma] \textbf{ wellformed}$ by lemma \ref{lemma:model_typing_soundness}
  \item \Z\Z $\code{(F *$p$=>$e$)}[\Sigma] \textbf{ wellformed}$ by substitution 
  \item \Z\Z $\textbf{let } v_0 \textbf{ s.t. } v_0 = \code{(F *$p$=>$e$)}[\Sigma]$ by lemma \TODO{... inversion ...} 
  \item \Z\Z $e_1[\Sigma] \textbf{ wellformed}$ by lemma \ref{lemma:model_typing_soundness}
  \item \Z\Z $\textbf{case } e_1[\Sigma] = v_1 \ \textbf{for} \ v_1$  
  \item \Z\Z\Z $\Omega \satisfies e_1[\Sigma] \hastype \tau_l$ by lemma \TODO{...} 
  \item \Z\Z\Z $\Omega \satisfies v_1 \hastype \tau_l$ by substitution 
  \item \Z\Z\Z $\textbf{let}\ \Sigma' \textbf{ s.t. } p \equiv v_1 \given \Sigma'$ by lemma \TODO{...} 
  ...
  \item \Z\Z\Z\Z $\forall e' .\ \neg F\code{($v_1$)} \rightsquigarrow e'$ by summarization 
  \item \Z\Z\Z\Z $\code{($F$*$p$=>$e$)($v_1$)} \rightsquigarrow e[\Sigma']$ by definition 
  \item \Z\Z\Z\Z \TODO{...} 
  \item \Z\Z\Z\Z $(\code{($F$*$p$=>$e$)($e_1$)})[\Sigma] \rightsquigarrow e[\Sigma \sqcup \Sigma']$ by definition  
  \item \Z\Z\Z\Z $\Omega, \Gamma \satisfies \code{($F$*$p$=>$e$)($e_1$)} \hastype \tau_r$ by definition \TODO{generalize definition}
  \item \Z\Z\Z $\textbf{case } \Omega, \Gamma \satisfies F \hastype \tau_l \code{->} \tau_r$ 
  \item \Z\Z\Z\Z $\Omega, \Gamma \satisfies \code{$F$($e_1$)} \hastype \tau_r$ by (outer) induction hypothesis \TODO{... make hypothesis explicit in each case, with application}
  \item \Z\Z\Z\Z $\textbf{let } e' \textbf{ s.t. } (\code{$F$($e_1$}))[\Sigma] \rightsquigarrow e' \land \Omega, \Gamma \satisfies e' \hastype \tau_r$ by lemma \TODO{inversion} 
  ...
  \item \Z\Z\Z $\Omega, \Gamma \satisfies \code{($F$*$p$=>$e$)($e_1$)} \hastype \tau_r$ by cases on $F = \epsilon \lor \Omega, \Gamma \satisfies F \hastype \tau_l \code{->} \tau_r$

  \item \Z\Z $\textbf{case } e_1[\Sigma] \rightsquigarrow e_1' \I e_1' \textbf{ wellformed} \ \textbf{for} \ e_1' $ 
  \item \Z\Z\Z $\Omega, \Gamma \satisfies \code{(F *$p$=>$e$)}\code{(}e_1'\code{)} \hastype \tau_r$ by induction hypothesis
  \item \Z\Z\Z $v_0\code{(}e_1[\Sigma]\code{)} \rightsquigarrow v_0\code{(}e_1'\code{)}$ by definition
  ...
  \item \Z\Z $\Omega, \Gamma \satisfies \code{(F *$p$=>$e$)}\code{(}e_1\code{)} \hastype \tau_r$ by induction on $e_1[\Sigma] \textbf{ wellformed}$
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  % \item \Z\Z $\textbf{let } \Sigma \textbf{ s.t. } \Omega, \Sigma \satisfies \Gamma $ by lemma \ref{lemma:model_typing_assignability} 
  % \item \Z\Z $e_1[\Sigma] \textbf{ wellformed}$ by lemma \ref{lemma:model_typing_soundness}
  % \item \Z\Z $\textbf{case } e_1[\Sigma] = v \ \textbf{for} \ v$  
  % \item \Z\Z\Z $\textbf{let } e_1' \textbf{ s.t. } F\code{(}v\code{)} \rightsquigarrow e_1'$ by lemma \ref{lemma:pattern_matching_progress} 
  % \item \Z\Z\Z $F\code{(}e_1[\Sigma]\code{)} \rightsquigarrow e_1'$ 
  % \item \Z\Z\Z $(F\code{(}e_1\code{)})[\Sigma] \rightsquigarrow e_1'$ 
  % \item \Z\Z\Z \TODO{...}
  % \item \Z\Z\Z $\Omega, \Gamma \satisfies e_1' \hastype \tau_r$
  % \item \Z\Z\Z $\Omega, \Gamma \satisfies F\code{(}e_1\code{)} \hastype \tau_r$
  % \item \Z\Z $\textbf{case } e_1[\Sigma] \rightsquigarrow e_1' \I e_1' \textbf{ wellformed} \ \textbf{for} \ e_1' $ 
  % \item \Z\Z\Z $\Omega, \Gamma \satisfies F\code{(}e_1'\code{)} \hastype \tau_r$ by induction hypothesis
  % \item \Z\Z\Z $F\code{(}e_1[\Sigma]\code{)} \rightsquigarrow F\code{(}e_1'\code{)}$
  % \item \Z\Z\Z $(F\code{(}e_1\code{)})[\Sigma] \rightsquigarrow F\code{(}e_1'\code{)}$
  % \item \Z\Z\Z $\Omega, \Gamma \satisfies F\code{(}e_1\code{)} \hastype \tau_r$ 

  % \item \Z\Z $\Omega, \Gamma \satisfies F\code{(}e_1\code{)} \hastype \tau_r$ by induction on $e_1[\Sigma] \textbf{ wellformed}$
  % \item \Z\Z $\Omega, \Gamma \satisfies F\code{(}e_1\code{)} \hastype \tau_r$ by substitution
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \item \Z $\textbf{case }
    ...
    \ \textbf{for}\ \Sigma\ e_0' 
  $
  \item \Z\Z $\Omega, \Gamma \satisfies e_0'\code{(}e_1\code{)} \hastype \tau_r$ by induction hypothesis
  ...
  \item \Z $\Omega, \Gamma \satisfies e_0\code{(}e_1\code{)} \hastype \tau_r$ by induction on $\Omega, \Gamma \satisfies e_0 \hastype \tau_l \code{->} \tau_r$  
  \item $\square$
\end{lemma}

% \begin{lemma}(Preservation of model typing)
%   \label{lemma:model_typing_preservation}
%   \begin{mathpar}
%     \inferrule {
%       \Omega, \Gamma \satisfies F \hastype \tau_l \code{->} \tau_r 
%       \\
%       F\code{(}v\code{)} \rightsquigarrow e
%     } {
%       \Omega, \Gamma \satisfies e \hastype \tau_r 
%     } 
%   \end{mathpar}
...
% \begin{lemma}(Progress of pattern matching)
%   \label{lemma:pattern_matching_progress}
%   \begin{mathpar}
%     \inferrule {
%       \code{*$p$=>$e$} \in F 
%       \\
...
\begin{lemma}(Assignability of model typing)
  \label{lemma:model_typing_assignability}
  \begin{mathpar}
    \inferrule { 
...
\begin{lemma}(Soundness of model typing)
  \label{lemma:model_typing_soundness}
  \begin{mathpar}
    \inferrule { 
      \Omega, \Sigma \satisfies \Gamma 
      \\
...
% \begin{lemma}(Progress of proof typing)
%   \label{lemma:proof_typing_soundness}
%   \begin{mathpar}
%     \inferrule { 
%       \Gamma \entails e \hastype \tau \given Z  
...
% \begin{lemma}(Preservation of proof typing)
%   \begin{mathpar}
%     \inferrule { 
%       \Gamma \entails e \hastype \tau \given Z  
%       \\
...
\begin{semantics}\boxed{\Omega, \Gamma \satisfies e \hastype \tau}
  ...
  \begin{mathpar}
    ...
    \inferrule { 
      ...
      \Omega, \Gamma \satisfies F\ \code{*$p$=>$e$} \hastype \code{$\tau_l$->$\tau_r$}
    } 
...
\begin{semantics}\boxed{\Omega, \Sigma \satisfies \Gamma}
  \label{semantics:model_typing_environment}
  \begin{mathpar}
    \inferrule { 
    } {
...
\begin{semantics}\boxed{\Omega \satisfies \tau <: \tau}
...
\begin{semantics}\boxed{\Omega \satisfies Q}
  \label{semantics:model_sequence_subtyping}
  \begin{mathpar}
    \inferrule { 
    } {

...
\begin{theorem}(Soundness of typing (Alternative))
  ...
  \item \I $\textbf{case}\ e \rightsquigarrow e' \I \entails e' \hastype \tau \implies e'\ \textbf{sound} (IH)$ 
  \item \I\I $\entails e' \hastype \tau$ by \D{Lemma \ref{lemma:preserveration}}
  \item \I\I $e'\ \textbf{sound}$ by \D{IH}
  \item \I\I $e\ \textbf{sound}$ by \D{Semantics \ref{semantics:sound_alternative}}

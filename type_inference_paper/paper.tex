...
}\ Pruning Interpretation (Negative)
\label{def:pruning_interpretation_negative}
  \begin{mathpar}
    \inferrule {
      \forall \delta .\ \delta \in \Delta' \iff \vec{\alpha}_\bullet, \Delta, \alpha \looparrowright^- \delta
      \\
      \llbracket \Delta\backslash\Delta', \alpha \rrbracket^- = (\Delta', \tau)
    } {
      \llbracket \vec{\alpha}_\closed \entails \Delta, \alpha \rrbracket^- = (\Delta', \tau)
    }
  \end{mathpar}
...
\label{def:indirection_negative}
  \begin{mathpar}
    \inferrule {
      ...
      \obj{;}\alpha'\obj{<:}\tau' \in \Delta 
      \\
      (\obj{;}\alpha\obj{<:}\tau = \delta) \lor (\obj{;}\alpha'\obj{<:}\tau' = \delta)
    } {

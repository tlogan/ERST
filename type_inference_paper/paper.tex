...
\begin{mathpar}
  ...
  \inferrule[Flex-L] {
    \alpha \notin Z_1
    \\\\
    Z_0, \Delta_0 \claim \Delta_z \lessdot \alpha \slash \tau_r
    \\
    Z_0, \Delta_0 \claim \Delta \ll \alpha \slash \tau_r
    \\\\
    Z_0 \preceq Z_1
    \\
    \Delta_0 \preceq \Delta_1
    \\
    Z_1, \Delta_1 \claim \Delta 
  } {
    Z_1, \Delta_1\ \Delta_z \cdot \code{$\alpha$<:$\tau_r$} \claim 
    \alpha \subtypes \tau_r
  }
  ...
  \inferrule[Flex-R] {
    \alpha \notin Z_1
    \\\\
    Z_0, \Delta_0 \claim \alpha \slash \tau_l \lessdot \Delta_z
    \\
    Z_0, \Delta_0 \claim \alpha \slash \tau_l \lessdot^\diamond \Delta_{zrel}
    \\\\
    Z_0, \Delta_0 \claim \alpha \slash \tau_l \ll \Delta 
    \\
    Z_0, \Delta_0 \claim \alpha \slash \tau_l \ll^\diamond \Delta_{rel}
    \\\\
    Z_0 \preceq Z_1
    \\
    \Delta_0 \preceq \Delta_1
    \\
    Z_1, \Delta_1 \claim \Delta\ \Delta_{rel} 
  } {
    Z_1, \Delta_1\ \Delta_z\ \Delta_{zrel} \cdot \code{$\tau_l$<:$\alpha$} \claim 
    \tau_l \subtypes \alpha
  }

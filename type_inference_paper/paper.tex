...
\begin{theorem}(Soundness of proof typing)
...
\begin{theorem}(Subsumption of model typing)
...
\begin{theorem}(Elimination of implication of model typing)
  ...
  \item \Z\Z\Z $\Omega \satisfies e_1[\Sigma] \hastype \tau_l$ by theorem \TODO{...} 
  \item \Z\Z\Z $\Omega \satisfies v_1 \hastype \tau_l$ by substitution 
  \item \Z\Z\Z $\textbf{let}\ \Sigma' \textbf{ s.t. } p \equiv v_1 \given \Sigma'$ by theorem \TODO{...} 
  ...
  \item \Z\Z\Z $e_1' = e_1'[\Sigma]$ by theorem \TODO{...} 
...
\begin{theorem}(valuation of wellformed function)
...
\begin{theorem}(Progress of function of model typing)
...
\begin{theorem}(Assignability of model typing)
...
\begin{theorem}(Soundness of model typing)
...
\begin{semantics}\boxed{\Omega, \Gamma \satisfies e \hastype \tau}\ (Model Typing)

...
\begin{figure*}[h]
  ...
  \begin{flalign*}
    &\boxed{\vec{z} \entails \alpha \circlearrowleft \vec{W} \cdot \code{$\alpha$->$\alpha$} \Rrightarrow \alpha \circlearrowright \vec{\tau}}&
  \end{flalign*}
  ...
  \begin{mathpar}
    \inferrule[TODO] {
      ...
      \vec{z} \entails \alpha \circlearrowleft \vec{W} \cdot \code{$\alpha$->$\alpha$} \Rrightarrow \alpha \circlearrowright \vec{\tau}
    }
  \end{mathpar}

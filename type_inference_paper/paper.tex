...
\begin{theorem}(Model typing implication elimination)
  ...
  \item \Z\Z\Z\Z $\code{($F[\Sigma]$*$p$=>$e[\Sigma]$)($v_1$)} \rightsquigarrow e[\Sigma][\Sigma']$ by definition 
  \item \Z\Z\Z\Z $\code{($F[\Sigma]$*$p$=>$e[\Sigma]$)($v_1$)} \rightsquigarrow e[\Sigma \sqcup \Sigma']$ by theorem \ref{...} \TODO{subbing with concat}

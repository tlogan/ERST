...
\begin{figure*}[h]
  \begin{flalign*}
    &\boxed{N, M \entails \Pi \equiv \mathrm{T}}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
  ...
  \begin{flalign*}
    &\boxed{M, \Delta \entails \mathrm{T} \subtypes \alpha}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
  ...
  \end{mathpar}
\caption{Proof semantics (rewriting)}
\label{fig:proof_semantics_rewriting}
\end{figure*}
...
\begin{figure*}[h]
  ...
  \end{mathpar}
\caption{Tools (rewriting)}
\label{fig:tools_rewriting}
\end{figure*}
...
\begin{figure*}[h]
  ...
  \begin{mathpar}
    ...
    \inferrule[Implication] { 
      ...
      \\
      \forall u_r' .\ u_l \triangleright u_r \in W \rightarrow u_r' = u_r 
    } {

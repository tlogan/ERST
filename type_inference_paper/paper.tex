...
\nonterm{\tau} & \is 
  ...
  \\
  \code{EXI[$\vec{\alpha}$ $Q$] $\tau$} \sep 
  \code{ALL[$\vec{\alpha}$ $Q$] $\tau$} \sep 
  \code{FIX[$\alpha$;$\tau$]}
  \end{array}
\\
\\
...
\\
\\
\nonterm{\vec{z}} & \is \epsilon \sep \vec{z}\ z
\\
\\
\nonterm{z} & \is \alpha 
\\
...
\\
\nonterm{r} & \is 
  \epsilon \sep r\ \code{;$l$=$e$}
\\
\\
\nonterm{f} & \is 
  \epsilon \sep f\ \code{case $p$=>$e$}
\\
\\
\nonterm{p} & \is 
  \code{$x$} \sep
...
\begin{figure*}[h]
  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \claim \Delta \Rightarrow \vec{z} \lessdot \alpha}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
      \vec{z}, \Delta \claim \epsilon \Rightarrow \epsilon \lessdot \alpha
    }

    \inferrule[Match] {
      z \in \vec{z}_0
      \\
      \vec{z}_0, \Delta_0 \claim \Delta_1 \Rightarrow \vec{z}_1 \lessdot \alpha
      \\\\
      \vec{z}_0, \Delta_0 \claim \Delta_0 \Rightarrow \vec{z}_2 \lessdot z 
    } {
      \vec{z}_0, \Delta_0 
      \claim \Delta_1 \cdot \code{$z$<:$\alpha$} 
      \Rightarrow \vec{z}_1\ \vec{z}_2\ z \lessdot \alpha
    }
    ...
    \inferrule[Skip] {
      ...
      \vec{z}_0, \Delta_0 
      \claim \Delta_1 \cdot \code{$\tau_l$<:$\tau_r$} 
      \Rightarrow \vec{z}_1 \lessdot \alpha
    }
  \end{mathpar}

  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \claim \Delta \Rightarrow \vec{\tau} \ll \alpha}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
      \vec{z}, \Delta \claim \epsilon \Rightarrow \epsilon \ll \alpha
    }

    \inferrule[Direct] {
      \tau \notin \vec{z}
      \\
      \vec{z}, \Delta_0 \claim \Delta_1 \Rightarrow \vec{\tau} \ll \alpha
    } {
      \vec{z}, \Delta_0 \claim \Delta_1 \cdot \code{$\tau$<:$\alpha$} \Rightarrow \vec{\tau}\ \tau \ll \alpha
    }

    \inferrule[Trans] {
      z \in \vec{z}
      \\
      \vec{z}, \Delta_0 \claim \Delta_1 \Rightarrow \vec{\tau}_0 \ll \alpha
      \\
      \vec{z}, \Delta_0 \claim \Delta_0 \Rightarrow \vec{\tau}_1 \ll z 
    } {
      \vec{z}, \Delta_0 \claim \Delta_1 \cdot \code{$z$<:$\alpha$} \Rightarrow \vec{\tau}_0\ \vec{\tau}_1 \ll \alpha
    }
    ...
    \inferrule[Skip] {
      ...
      \vec{z}, \Delta_0 \claim \Delta_1 \cdot \code{$\tau_l$<:$\tau_r$} \Rightarrow \vec{\tau} \ll \alpha
    }
  \end{mathpar}

  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \claim \Delta \Rightarrow \alpha \lessdot \vec{z}}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
      \vec{z}, \Delta \claim \epsilon \Rightarrow \alpha \lessdot \epsilon
    }

    \inferrule[Match] {
      z \in \vec{z}_0
      \\
      \vec{z}_0, \Delta_0 \claim \Delta_1 \Rightarrow \alpha \lessdot \vec{z}_1 
      \\\\
      \vec{z}_0, \Delta_0 \claim \Delta_0 \Rightarrow z \lessdot \vec{z}_2 
    } {
      \vec{z}_0, \Delta_0 \claim \Delta_1 \cdot \code{$\alpha$<:$z$} \Rightarrow \alpha \lessdot \vec{z}_1\ \vec{z}_2\ z 
    }
    ...
    \inferrule[Skip] {
      ...
      \vec{z}_0, \Delta_0 \claim \Delta_1 \cdot \code{$\tau_l$<:$\tau_r$} \Rightarrow  \alpha \lessdot \vec{z}_1
    }
  \end{mathpar}

  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \claim \Delta \Rightarrow \alpha \ll \vec{\tau}}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
      \vec{z}, \Delta \claim \epsilon \Rightarrow \alpha \ll \epsilon
    }

    \inferrule[Direct] {
      \tau \notin \vec{z}
      \\
      \vec{z}, \Delta_0 \claim \Delta_1 \Rightarrow \alpha \ll \vec{\tau}
    } {
      \vec{z}, \Delta_0 \claim \Delta_1 \cdot \code{$\alpha$<:$\tau$} \Rightarrow \alpha \ll \vec{\tau}\ \tau
    }

    \inferrule[Trans] {
      z \in \vec{z}
      \\
      \vec{z}, \Delta_0 \claim \Delta_1 \Rightarrow \alpha \ll \vec{\tau}_0
      \\
      \vec{z}, \Delta_0 \claim \Delta_0 \Rightarrow z \ll \vec{\tau}_1
    } {
      \vec{z}, \Delta_0 \claim \Delta_1 \cdot \code{$\alpha$<:$z$} \Rightarrow \alpha \ll \vec{\tau}_0\ \vec{\tau}_1
    }
    ...
    \inferrule[Skip] {
      ...
      \vec{z}, \Delta_0 \claim \Delta_1 \cdot \code{$\tau_l$<:$\tau_r$} \Rightarrow \alpha \ll \vec{\tau}
    }
  \end{mathpar}
...
\begin{figure*}[h]
  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \claim \Delta \Rightarrow \alpha \lessdot \Delta}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
    ...
    \inferrule[Match] {
      ...
      z_0 \in \vec{z}_0
      \\
      \vec{z}_0, \Delta_0 \claim \Delta_1 \Rightarrow \alpha \lessdot \Delta_2
      \\
      \vec{z}_0, \Delta_0 \claim \Delta_0 \Rightarrow z_0 \lessdot \vec{z}_1 
    } {
      \vec{z}_0, \Delta_0
      \claim
  ...
  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \claim \Delta \Rightarrow \alpha \ll \Delta}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
    ...
    \inferrule[Direct] {
      ...
      \tau \notin \vec{z}
      \\
      \vec{z}, \Delta_0 \claim \Delta_1 \Rightarrow \alpha \ll \Delta_2
    } {
      \vec{z}, \Delta_0 \claim \Delta_1 \cdot \code{$\tau_l$<:$\tau_r$} \Rightarrow \alpha \ll \Delta_2 \cdot \code{$\tau_l$<:$\tau_r$}
    }
    ...
    \inferrule[Trans] {
      ...
      \vec{z}, \Delta_0 \claim \Delta_1 \Rightarrow \alpha \ll \Delta_2
      \\\\
      \vec{z}, \Delta_0 \claim \Delta_0 \Rightarrow z \ll \Delta_3 
    } {
      \vec{z}, \Delta_0 \claim \Delta_1 \cdot \code{$\tau$<:$z$} \Rightarrow \alpha \ll \Delta_2\ \Delta_3
    }
    ...
    \inferrule[Skip] {
      ...
      \vec{z}, \Delta_0 \claim \Delta_1 \cdot \code{$\tau_l$<:$\tau_r$} \Rightarrow \alpha \ll \Delta_2
    }
  \end{mathpar}
...
\begin{figure*}[h]
  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \claim \tau \subtypes \tau}&
  \end{flalign*}

  \begin{mathpar}
    \inferrule[Refl] {
    } {
      \vec{z}, \Delta \claim \tau \subtypes \tau
    }

    \inferrule[Bot-L] {
    } {
      \vec{z}, \Delta \claim \code{BOT} \subtypes \tau_r
    }

    \inferrule[Top-R] {
    } {
      \vec{z}, \Delta \claim \tau_l \subtypes \code{TOP}
    }

    \inferrule[Inter-Target] {
      \vec{z}, \Delta \claim \tau_l
      \subtypes
      \code{($l$:$\tau_{rl}$)\&($l$:$\tau_{rr}$)}
    } {
      \vec{z}, \Delta \claim \tau_l \subtypes 
      \code{$l$:($\tau_{rl}$\&$\tau_{rr}$)}
    }

    \inferrule[Unio-L] {
      \vec{z}_0, \Delta_0 \claim \tau_{ll} \subtypes \tau_r
      \\
      \vec{z}_0 \preceq \vec{z}_1
      \\\\
      \Delta_0 \preceq \Delta_1
      \\
      \vec{z}_1, \Delta_1 \claim \tau_{lr} \subtypes \tau_r
    } {
      \vec{z}_1, \Delta_1 \claim \code{$\tau_{ll}$|$\tau_{lr}$} \subtypes \tau_r
    }

    \inferrule[Inter-R] {
      \vec{z}_0, \Delta_0 \claim \tau_l \subtypes \tau_{rl}
      \\
      \vec{z}_0 \preceq \vec{z}_1
      \\\\
      \Delta_0 \preceq \Delta_1
      \\
      \vec{z}_1, \Delta_1 \claim \tau_l \subtypes \tau_{rr}
    } {
      \vec{z}_1, \Delta_1 \claim \tau_l \subtypes \code{$\tau_{rl}$\&$\tau_{rr}$} 
    }
    ...
    \inferrule[Inter-Conseq] {
      ...
      \vec{z}, \Delta \claim \tau_l \subtypes \code{$\tau_{ra}$->$\tau_{rb}$\&$\tau_{rc}$}
    }

    \inferrule[Exi-L] {
      \vec{\alpha} \cdot \Delta = Q
      \\
      \vec{z}_0, \Delta_0 \claim \Delta
      \\\\
      \vec{z}_0\ \vec{\alpha} \preceq \vec{z}_1
      \\
      \Delta_0 \preceq \Delta_1
      \\
      \vec{z}_1, \Delta_1 \claim
      \tau_l \subtypes \tau_r
    } {
      \vec{z}_1, \Delta_1 \claim 
    ...
    \inferrule[Flex-L] {
      \alpha \notin \vec{z}_1
      \\
      \vec{z}_0, \Delta_0 \claim \Delta_0 \Rightarrow \vec{z} \lessdot \alpha
      \\
      \vec{z}_0, \Delta_0 \claim \Delta_0 \Rightarrow \vec{\tau} \ll \alpha
      \\
      \vec{z}_0 \preceq \vec{z}_1
      \\
      \Delta_0 \preceq \Delta_1
      \\
      \vec{z}_1, \Delta_1 \claim \widebar{\cdot \tau \code{<:} \tau_r}^{\tau \in \vec{\tau}}
    } {
      \vec{z}_1, \Delta_1\ \widebar{\cdot \code{$z$<:$\tau_r$}}^{z \in \vec{z}} \cdot \code{$\alpha$<:$\tau_r$} \claim 
      \alpha \subtypes \tau_r
    }
    ...
    \inferrule[Flex-R] {
      \alpha \notin \vec{z}_1
      \\
      \vec{z}_0, \Delta_0 \claim \Delta_0 \Rightarrow \alpha \lessdot \vec{z}
      \\
      \vec{z}_0, \Delta_0 \claim \Delta_0 \Rightarrow \alpha \lessdot \Delta_{skol}
      \\
      \vec{z}_0, \Delta_0 \claim \Delta_0 \Rightarrow \alpha \ll \vec{\tau} 
      \\
      \vec{z}_0, \Delta_0 \claim \Delta_0 \Rightarrow \alpha \ll \Delta_{rel}
      \\
      \vec{z}_0 \preceq \vec{z}_1
      \\
      \Delta_0 \preceq \Delta_1
      \\
      \vec{z}_1, \Delta_1 \claim \widebar{\cdot \code{$\tau_0[\alpha\slash\tau_l]$<:$\tau_1$}}^{\cdot \code{$\tau_0$<:$\tau_1$}\in\Delta_{rel}}\ \widebar{\cdot\code{$\tau_l$<:$\tau$}}^{\tau \in \vec{\tau}}
    } {
      \vec{z}_1, \Delta_1
      ...
      \claim \tau_l \subtypes \alpha
    }

    \inferrule[Skolem-L] {
      \alpha \in \vec{z}
      \\
      \alpha \code{<:} \tau \in (\Delta\ \text{factor}(\Delta, \alpha))
      \\
      \vec{z}, \Delta \claim \tau \subtypes \tau_r
    } {
      \vec{z}, \Delta \claim \alpha \subtypes \tau_r
    }

    \inferrule[Skolem-R] {
      \alpha \in \Omega
      \\
      \tau \code{<:} \alpha \in \Delta
      \\
      \vec{z}, \Delta \claim \tau_l \subtypes \tau
    } {
      \vec{z}, \Delta \claim \tau_l \subtypes \alpha
    }

    \inferrule[All-L] {
      \vec{z}_0, \Delta_0 \claim \tau_l \subtypes \tau_r
      \\
      \vec{z}_0 \preceq \vec{z}_1
      \\
      \Delta_0 \preceq \Delta_1
    ...
    \inferrule[Exi-R] {
      ...
      \vec{z}_1, \Delta_1 \claim \tau_l
      \subtypes 
      \code{EXI[$Q$]$\tau_r$}
    }

    \inferrule[Inter-LL] {
      \vec{z}, \Delta \claim \tau_{ll} \subtypes \tau_r
    } {
      \vec{z}, \Delta \claim \code{$\tau_{ll}$\&$\tau_{lr}$}  \subtypes \tau_r
    }

    \inferrule[Inter-LR] {
      \vec{z}, \Delta \claim \tau_{lr} \subtypes \tau_r
    } {
      \vec{z}, \Delta \claim \code{$\tau_{ll}$\&$\tau_{lr}$}  \subtypes \tau_r
    }

    \inferrule[Unio-RL] {
      \vec{z}, \Delta \claim \tau_l \subtypes \tau_{rl}
    } {
      \vec{z}, \Delta \claim \tau_l \subtypes \code{$\tau_{rl}$|$\tau_{rr}$}
    }

    \inferrule[Unio-RR] {
      \vec{z}, \Delta \claim \tau_l \subtypes \tau_{rr}
    } {
      \vec{z}, \Delta \claim \tau_l \subtypes \code{$\tau_{rl}$|$\tau_{rr}$}
    }
...
\begin{figure*}[h]
  ...
  \begin{mathpar}
    \inferrule[Fixpoint-L] {
      % \vec{z}\ \alpha, \Delta \cdot \alpha \code{<:} \tau_r \claim \tau_l \subtypes \tau_r 
      % \\\\
      % \text{VS}
      % \\\\
      \vec{z}, \Delta \claim \tau_l[\alpha\slash\tau_r] \subtypes \tau_r 
    } {
      \vec{z}, \Delta
      \claim \code{FIX[$\alpha$]$\tau_l$} \subtypes \tau_r 
    }
    ...
    \inferrule[Fixpoint-R] {
      \text{decidable}(\Delta, \tau_l, \code{FIX[$\alpha$]$\tau_r$})
      \\
      \vec{z}, \Delta \claim 
    ...
    \inferrule[Skolem-L-Fixpoint-R] {
      z \in \text{FV}(\tau_l) \\ z \in \vec{z}
      \\
      \text{norm}(\code{$\tau_l$<:FIX[$\alpha$]$\tau_r$}) = \code{$\tau_l'$<:FIX[$\alpha$]$\tau_r'$}
      \\\\
      \code{$\tau_l'$<:$\tau$} \in \text{norm}(\Delta)
      \\
      \vec{z}, \Delta
      \claim \tau \subtypes \code{FIX[$\alpha$]$\tau_r'$}
    } {
      \vec{z}, \Delta
      \claim \tau_l \subtypes \code{FIX[$\alpha$]$\tau_r$}
    }

    \inferrule[Flex-L-Fixpoint-R] {
      \vec{z}, \Delta, \text{FV}(\tau_l) \claim \Omega
      \\
      \vec{z}, \Delta
      \claim \tau_l[\Omega] \subtypes \code{FIX[$\alpha$]$\tau_r$}
      \\
      \text{WF}(\tau_l\code{<:}\code{FIX[$\alpha$]$\tau_r$})
    } {
      \vec{z}, \Delta \cdot \code{$\tau_l$<:FIX[$\alpha$]$\tau_r$}
      \claim \tau_l \subtypes \code{FIX[$\alpha$]$\tau_r$}
    }

    \inferrule[Diff-L] {
      \vec{z}, \Delta \claim \tau_l \subtypes \code{$\tau_r$|$\tau_n$}
    } {
      \vec{z}, \Delta \claim 
    ...
    \inferrule[Diff-R] {
      ...
      \\
      \vec{z}, \Delta \claim \tau_l \subtypes \tau_r
      \\
      \neg(\vec{z}, \Delta \claim \tau_l \subtypes \tau_n)
    } {
      \vec{z}, \Delta
      \claim 
    ...
    \inferrule[Tag] {
      \vec{z}, \Delta 
      \claim \tau_l \subtypes \tau_r
    } {
      \vec{z}, \Delta 
      \claim \code{\textasciitilde$l$ $\tau_l$} \subtypes \code{\textasciitilde$l$ $\tau_r$}
    }
    ...
    \inferrule[Record] {
      ...
      \vec{z}, \Delta 
      \claim \code{$l$:$\tau_l$} \subtypes \code{$l$:$\tau_r$}
    }

    \inferrule[Imp] {
      \vec{z}_0, \Delta_0 \claim \tau_{rl} \subtypes \tau_{ll}
      \\
      \vec{z}_0 \preceq \vec{z}_1
      \\
      \Delta_0 \preceq \Delta_1
      \\
      \vec{z}_1, \Delta_1 \claim \tau_{lr} \subtypes \tau_{rr}
    } {
      \vec{z}_1, \Delta_1 
      \claim \code{$\tau_{ll}$->$\tau_{lr}$} \subtypes \code{$\tau_{rl}$->$\tau_{rr}$}
    }
  \end{mathpar}

  \begin{flalign*}
    &\boxed{\tau \subtypes \tau \dashv \vec{W}}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Aggregate] {
      \forall  \vec{z}\ \Delta .\  
      \tau_l \subtypes \tau_r \dashv \vec{z}, \Delta 
      \leftrightarrow 
      \left< \vec{z}, \Delta \right> \in \vec{W}
    } {
      \tau_l \subtypes \tau_r \dashv \vec{W}
    }
...
\begin{figure*}[h]
\begin{flalign*}
  &\boxed{\vec{z}, \Delta, \vec{\alpha} \claim \Omega}&
\end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
      \vec{z}, \Delta, \epsilon \claim \epsilon
    }
    ...
    \inferrule[Miss] {
      ...
      \\
      \vec{z}, \Delta, \vec{\alpha} \claim \Omega
    } {
      \vec{z}, \Delta, \vec{\alpha}\ \alpha \claim \Omega
    }
...
\end{flalign*}
  \begin{mathpar}
    \inferrule[Extension] {
      ...
      \Delta_0 \preceq \Delta_1
      \\
      \vec{z}_1, \Delta_1 \claim \tau_l \subtypes \tau_r
    } {
      \vec{z}_1, \Delta_1
      \claim 
...
\begin{figure*}[h]
  \begin{flalign*}
    &\boxed{\Gamma \claim e \hastype \tau \dashv \vec{W}}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Unit] {
    } {
      \Gamma \claim \code{@} \hastype \code{@} \dashv \vec{W}
    }

    \inferrule[Var] {
      \cdot \code{$x$:$\tau$} \in \Gamma
    } {
      \Gamma \claim x \hastype \tau \dashv \vec{W} 
    }

    \inferrule[Tag] {
      \Gamma \claim e \hastype \tau \dashv \vec{W}
    } {
      \Gamma \claim \code{\ttilde $l$ $e$} \hastype \code{\ttilde $l$ $\tau$} \dashv \vec{W}
    }

    \inferrule[Empty] {
    } {
      \Gamma \claim \epsilon \hastype \code{TOP} \dashv \vec{W}
    }

    \inferrule[Record] {
      \Gamma \claim r \hastype \tau_0 \dashv \vec{W}_0
      \\
      \vec{W}_0 \looparrowright \vec{W}_1
      \\
      \Gamma \claim e \hastype \tau_1 \dashv \vec{W}_1
    } {
      \Gamma \claim r\ \code{;$l$=$e$} \hastype \tau_0\ \code{\&}\ \code{$l$:$\tau_1$} \dashv \vec{W}_1
    }

    \inferrule[Function] {
      \vec{W}, \Gamma \claim f \liftfun \vec{\pi}, \vec{\eta} 
      \\
      \Gamma \claim \vec{\pi} \Rrightarrow \tau
    } {
      \Gamma \claim f \hastype \tau \dashv \vec{W}
    }

    \inferrule[Projection] {
      \Gamma \claim e \hastype \tau_0 \dashv \vec{W}_0
      \\
      \alpha\ \#\ \Gamma, \vec{W}_0
      \\
      \vec{W}_0 \looparrowright \vec{W}_1
      \\
      \tau_0 \subtypes \code{$l$:$\alpha$} \dashv \vec{W}_1
    } {
      \Gamma \claim \code{$e$.$l$} \hastype \alpha \dashv \vec{W}_1
    }

    \inferrule[Application] {
      \Gamma \claim e_0 \hastype \tau_0 \dashv \vec{W}_0
      \\
      \vec{W}_0 \looparrowright \vec{W}_1
      \\
      \Gamma \claim e_1 \hastype \tau_1 \dashv \vec{W}_1
      \\
      \alpha\ \#\ \Gamma, \vec{W}_1
      \\
      \vec{W}_1 \looparrowright \vec{W}_2
      \\
      \tau_0 \subtypes \code{$\tau_1$->$\alpha$} \dashv \vec{W}_2
    } {
      \Gamma \claim \code{$e_0$($e_1$)} \hastype \alpha \dashv \vec{W}_2
    }

    \inferrule[Recursion] {
      TODO
    } {
      \Gamma \claim \code{fix($e$)} \hastype \alpha \dashv \vec{W}_1
    }

  \end{mathpar}

  \begin{flalign*}
    &\boxed{\vec{W}, \Gamma \claim f \liftfun \vec{\pi}, \vec{\eta}}&
  \end{flalign*}
  \begin{mathpar}

    \inferrule[Step] {
      \vec{W}_0, \Gamma_0 \claim f \liftfun \vec{\pi}, \vec{\eta}
      \\\\
      p \liftpat \tau_0 \dashv \Gamma_1
      \\
      \vec{W}_0 \looparrowright \vec{W}_1
      \\
      \Gamma_0\ \Gamma_1 \claim e \hastype \tau_1 \dashv \vec{W}_1
      \\
      \left< \vec{W}_1, \text{neg}(\tau_0, \vec{\eta}), \tau_1 \right> = \pi
    } {
      \vec{W}_0, \Gamma_0 \claim f\ \code{case $p$=>$e$} \liftfun 
      \vec{\pi}\ \pi, \vec{\eta}\ \tau_0
    }
  \end{mathpar}
  ...
  \begin{flalign*}
    &\boxed{\Gamma \claim \vec{\pi} \Rrightarrow \tau}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[TODO] {
    } {
      \vec{\Gamma} \claim \vec{\pi} \Rrightarrow \tau
    }
  \end{mathpar}

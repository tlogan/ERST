...
\begin{figure*}[h]
  ...
  \begin{mathpar}
    ...
    \inferrule[Flex-L] {
      ...
      \vec{z}_1, \Delta_1\ \widebar{\code{;$z$<:$\tau_r$}}^{z \in \vec{z}} \cdot \code{$\alpha$<:$\tau_r$} \claim 
      \alpha \subtypes \tau_r
    }
    ...
    \inferrule[Flex-R] {
      ...
      \Delta_0 \preceq \Delta_1
      \\
      \vec{z}_1, \Delta_1 \claim \widebar{\code{;$\tau_0[\alpha\slash\tau_l]$<:$\tau_1$}}^{\code{;$\tau_0$<:$\tau_1$}\in\Delta_{rel}} \code{;$\tau_l$<:}\code{\&}(\vec{\tau})
    } {
      \vec{z}_1, \Delta_1
      \ \widebar{\code{;$\tau_l$<:$z$}}^{z\in\vec{z}}
      \ \widebar{\code{;$\tau[\alpha\slash\tau_l]$<:$z$}}^{\code{;$\tau$<:$z$} \in \Delta_{skol}} \cdot \code{$\tau_l$<:$\alpha$} 

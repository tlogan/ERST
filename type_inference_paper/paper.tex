...
\begin{lemma}(Soundness of model typing)
  ...
  \item \I $\textbf{case } e = \code{\ttilde}\ e' \I 
            ...
            \Omega, \Gamma \satisfies e' \hastype \tau'
            $
  \item \I $\textbf{w/ IH } e' \textbf{ sound}$
  ...
  \item \I\I $e \textbf{ sound}$ by cases on $e' \textbf{ sound}$ (Semantics \ref{semantics:sound_alternative})

  \item \I $e \textbf{ sound}$ by induction on $e$ (Syntax \ref{syntax:expression})

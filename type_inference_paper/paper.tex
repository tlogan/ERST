...
\begin{mathpar}
  ...
  \inferrule[ApplicationSingle] {
    ...
    \code{(case $p$=>$e$)($v$)} \rightsquigarrow \text{subst}(e, \Omega)
  }
  ...
  \inferrule[LetContin] {
    ...
    \code{let $x$:$\tau$ = $v$ in $e$} \rightsquigarrow \text{subst}(e, \epsilon \cdot x \mapsto v)
  }
  ...
  \inferrule[Recursion] {
    ...
    \code{fix(case $x$ => $e$)} \rightsquigarrow \text{subst}(e, \epsilon \cdot x \mapsto \code{fix(case $x$ => $e$)})
  }
...
\\
\I u \in \llbracket \tau \rrbracket\ \land\ 
\\
...
\\ 
\I u_a \in \llbracket \tau_a \rrbracket \rightarrow u_c \in \llbracket \tau_c \rrbracket\ \land\ 
\\
...
\\ \I u \in \llbracket subst(\sigma, \tau) \rrbracket
\\
\}
\end{array}
& 
...
&=& 
\begin{array}[t]{@{}l}
\mu  \mathbb{V}' . \{ u  \ |\  \exists u' . 
\\ \I u' \in \mathbb{V}' \ \land\ 
\\ \I u \in \llbracket subst(\{\alpha \mapsto u'\}, \tau) \rrbracket
\\
\}
\end{array}
& 

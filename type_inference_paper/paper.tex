...
\begin{theorem}(Proof subtyping soundness)
  ...
  $
    ...
    $
    \item \Z $\B{hypo } 
      \exists \Omega .\ \Omega \satisfies \tau_{ll} \subtypes \tau_r
      \I
      \exists \Omega .\ \Omega \satisfies \tau_{lr} \subtypes \tau_r
    $

    \item \Z $\B{hypo } 
      \forall \Omega .\ M_0, \Omega \satisfies \Delta_0  \implies \Omega \satisfies \tau_{ll} \subtypes \tau_r
      \I
      \forall \Omega .\ M_1, \Omega \satisfies \Delta_1 .\ \Omega \satisfies \tau_{lr} \subtypes \tau_r
    $
    \item \Z $\B{wrt } \tau_{ll}\ \tau_{lr}$

      \item \Z\Z $\B{for } \Omega \B{ assume } M, \Omega \satisfies \Delta$
        \item \Z\Z\Z $M_1, \Omega \satisfies \Delta_1$ by substitution 
        \item \Z\Z\Z $\Omega \satisfies \tau_{lr} \subtypes \tau_r$ by application 
        \item \Z\Z\Z $M_0, \Omega \satisfies \Delta_0$ by theorem \ref{...} \TODO{...} 
      ...
      \item \Z\Z $\forall \Omega .\ M, \Omega \satisfies \Delta \implies \Omega \satisfies \tau_l \subtypes \tau_r$ 
      by implication and generalization
    ...
    \item \Z $
      ...
      \Omega \satisfies \tau_l \subtypes \tau_r
    $ by induction
    \item \Z $\forall \Omega .\ M, \Omega \satisfies \Delta \implies \Omega \satisfies \tau_l \subtypes \tau_r$ 
    by induction
  \item $\square$ by implication
\end{theorem}

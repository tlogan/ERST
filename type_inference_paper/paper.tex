...
% & \C{variable}
% \\
\llbracket \Delta, \Omega, \code{@} \rrbracket 
&=& 
\{\code{@}\} 
& \C{unit} 
\\
\llbracket \Delta, \Omega, \code{\textasciitilde{}$l$ $\tau$} \rrbracket 
&=& 
\{ \code{\textasciitilde{}$l$ $v$}\ |\ v \in \llbracket \Delta, \Omega, \tau \rrbracket \}
& \C{tag} 
\\
\llbracket \Delta, \Omega, \code{$l$:$\tau$} \rrbracket 
&=&{} 
\{ \code{$l$:$v$}\ |\ v \in \llbracket \Delta, \Omega, \tau \rrbracket \}
& \C{field} 
\\
\llbracket \Delta, \Omega, \code{$\tau_a$->$\tau_c$} \rrbracket 
&=& 
\begin{array}[t]{@{}l}
\{ v_f \ |\ 
\\ \I v_a \in \llbracket \Delta, \Omega, \tau_a \rrbracket\ \land\ 
\\ \I v_c \in \llbracket \Delta, \Omega, \tau_c \rrbracket\ \land\ 
...
& \C{implication} 
\\
\llbracket \Delta, \Omega, \code{$\tau_a$|$\tau_b$} \rrbracket 
&=& 
\llbracket \Delta, \Omega, \tau_a \rrbracket 
\cup
\llbracket \Delta, \Omega, \tau_b \rrbracket 
& \C{union}
\\
\llbracket \Delta, \Omega, \code{$\tau_a$\&$\tau_b$} \rrbracket 
&=& 
...
& \C{intersection}
\\
\llbracket \Delta, \Omega, \code{$\tau_a$\textbackslash$\tau_b$} \rrbracket 
&=& 
\llbracket \Delta, \Omega, \tau_a \rrbracket 
\ \backslash\ 
\llbracket \Delta, \Omega, \tau_b \rrbracket 
& \C{difference}
\\
\llbracket \code{ANY[$\widebar{\alpha}$ $Q$] $\tau$} \rrbracket 
&=& 
\begin{array}[t]{@{}l}
\{ v \ |\  \exists \sigma . 
\\ \I keys(\sigma) = \{\widebar{\alpha}\}\ \land\ \llbracket subst(\sigma, Q) \rrbracket \ \land\ 
...
\C{indexed union}
\\
\llbracket \Delta, \Omega, \code{ALL[$\widebar{\alpha}$ $Q$] $\tau$} \rrbracket 
&=& 
\begin{array}[t]{@{}l}
\{ v \ |\  \forall \sigma . 
\\ \I keys(\sigma) = \{\widebar{\alpha}\}\ \land\ \llbracket subst(\sigma, Q) \rrbracket \ \rightarrow  
\\ \I v \in \llbracket subst(\sigma, \tau) \rrbracket
\\
\}
\end{array}

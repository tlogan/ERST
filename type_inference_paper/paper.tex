...
\\
\nonterm{\sigma} & \is 
  \epsilon \sep \sigma \cdot x \mapsto v
\\
\\
\nonterm{\omega} & \is 
  \epsilon \sep \omega \cdot \alpha \mapsto \tau
\\  
\\  
\nonterm{\Gamma} & \is 
...
\\ 
\I u \in \llbracket \text{subst}(\epsilon \cdot \alpha \mapsto \tau', \tau) \rrbracket
\\
\}
\end{array}
& 
...
\begin{figure*}[h]
\begin{flalign*}
  &\boxed{K, \Delta \claim \tau \subtypes \tau}&
\end{flalign*}
...
\begin{mathpar}
  ...
  \inferrule[Exi-L] {
    ...
    \\
    K, \Delta_0 \claim \Delta
    \\
    \Delta_0 \preceq \Delta_1
    \\\\
    K\ \vec{\alpha}, \Delta_1 \claim
    \tau_l \subtypes \tau_u
  } {
    K, \Delta_1 \claim 
    \code{(EXI[$Q$] $\tau_l$)} \subtypes \tau_u
  }

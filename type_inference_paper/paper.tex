...
\begin{lemma}(Soundness of model typing)
  ...
  \TODO{should induct over e; don't really care what $\tau$ is}
  \TODO{this is wrong below. would need}
  ...
  \TODO{consider removing explicit variable rule; a variable is an elimination rule}
  \item \I $\textbf{case } e = x \I x \hastype \tau \in \Gamma \I \tau \textbf{ inhab}$
  \item \I\I \TODO{tricky. See how Cretin handle's such a case}
...
\begin{semantics}\boxed{\Omega, \Gamma \satisfies e \hastype \tau}
  ...
  \begin{mathpar}
    ...
    \inferrule { 
      e \rightsquigarrow e'[x \slash v]
      \\
      \Omega, \Gamma \satisfies v \hastype \tau' 
      \\
      \Omega, \Gamma \ x \slash v \satisfies e' \hastype \tau 
    } {
      \Omega, \Gamma \satisfies e \hastype \tau 
    } 
  \end{mathpar}

...
\begin{semantics}\boxed{e\ \textbf{valid}}
  \begin{mathpar}
    \inferrule { 
      e \rightsquigarrow e' 
    } {
...
\begin{semantics}\boxed{e\ \textbf{sound}}
  ...
  \begin{mathpar}
    \inferrule { 
      e\ \textbf{valid} 
      \\
      \forall e' .\ e \rightsquigarrow^\star e' \implies e'\ \textbf{valid}
    } {
      e\ \textbf{sound}
    } 
  \end{mathpar}
...
\begin{theorem}(Soundness of typing)
  ...
  \item \I\I\I $e''\ \textbf{valid}$ by \D{Semantics \ref{semantics:sound}} 
  \item \I\I\I $\forall e''' .\ e'' \rightsquigarrow^\star e''' \implies e'''\ \textbf{valid}$ by \D{Semantics \ref{semantics:sound}}
  \item \I\I\I $e'' \rightsquigarrow^\star e' \implies e'\ \textbf{valid}$ by universal 
  \item \I\I\I $e'\ \textbf{valid}$ by implication 

  \item \I $\forall e' .\ e \rightsquigarrow^\star e' \implies e'\ \textbf{valid}$ by derivation

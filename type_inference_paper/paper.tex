...
\begin{lemma}(Soundness of proof typing)
  ...
  \end{mathpar}
  Proof ... 
  \item \TODO{Cretin has lemmas showing elimination forms mirror proof typing rules. see Lemma 91, p. 129}
\end{lemma}
\TODO{Cretin's corresponding theorem is on p. 134}
\TODO{See how Cretin proves this without using subject reduction}

\begin{lemma}(Subsumption in model typing)
...
\begin{lemma}(Application in model typing)
  \label{lemma:application_model_typing}
  \begin{mathpar}
    \inferrule { 
...
\begin{lemma}(Soundness of model typing)
  ...
  $
  \item \Z\Z $e' \textbf{ sound}$ by induction hypothesis
  ...
  \item \Z\Z $\textbf{case } e'[\Sigma] \rightsquigarrow e'' \I e'' \textbf{ sound}$
  ...
  \item \Z\Z $e[\Sigma] \textbf{ sound}$ by cases on $e' \textbf{ sound}$
  ...
  \item \Z $e[\Sigma] \textbf{ sound}$ by induction on $\Omega, \Gamma \satisfies e \hastype \tau$
  \item $\square$

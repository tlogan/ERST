...
\begin{mathpar}
  ...
  \inferrule[Flex-L] {
    ...
    \\
    Z_0, \Delta_0 \claim Z \lessdot \alpha
    \\\\
    Z_0 \preceq Z_1
    \\
    \Delta_0 \preceq \Delta_1
    \\
    Z_1, \Delta_1 \claim \Box_{\tau \in \vec{\tau}}(\code{;$\tau$<:$\tau_r$})
    \\\\
    \Box_{\alpha_z \in Z}(\code{;$\alpha_z$<:$\tau_r$}) = \Delta_z
    \\
    \Delta_1\ \Delta_z \cdot \code{$\alpha$<:$\tau_r$} \preceq \Delta_2
  } {
    Z_1, \Delta_2 \claim 
    \alpha \subtypes \tau_r
  }

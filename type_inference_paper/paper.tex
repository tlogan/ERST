...
\begin{mathpar}
  ...
  \inferrule[LetContin] {
    ...
    \code{let $x$:$\tau$ = $v$ in $e$} \rightsquigarrow \text{subst}(e, \square \cdot x \slash v)
  }
  ...
  \inferrule[Recursion] {
    ...
    \code{fix(case $x$ => $e$)} \rightsquigarrow \text{subst}(e, \square \cdot x \slash \code{fix(case $x$ => $e$)})
  }
...
\begin{figure*}[h]
  ...
  \begin{mathpar}
    \inferrule[Empty] {
      ...
      \vec{z}, \Delta \claim \square \Rightarrow \square \lessdot \alpha
    }
  ...
  \begin{mathpar}
    \inferrule[Empty] {
      ...
      \vec{z}, \Delta \claim \square \Rightarrow \square \ll \alpha
    }
  ...
  \begin{mathpar}
    \inferrule[Empty] {
      ...
      \vec{z}, \Delta \claim \square \Rightarrow \alpha \lessdot \square
    }
  ...
  \begin{mathpar}
    \inferrule[Empty] {
      ...
      \vec{z}, \Delta \claim \square \Rightarrow \alpha \ll \square
    }
...
\begin{figure*}[h]
  ...
  \begin{mathpar}
    ...
    \inferrule[Flex-L-Fixpoint-R] {
      \forall \alpha' .\ \alpha' \in \text{FV}(\tau_l) \rightarrow 
      \alpha' \notin \vec{z} \land
      \Delta, \alpha' \claim \omega
      \\
      \vec{z}, \Delta
...
\begin{figure*}[h]
\begin{flalign*}
  &\boxed{\Delta, \alpha \claim \omega}&
\end{flalign*}
  \begin{mathpar}
    \inferrule[Miss] {
      \forall \tau .\ \cdot \code{$\tau$<:$\alpha$} \notin \Delta
      \\
      \forall \tau .\ \cdot \alpha \mapsto \tau \notin \omega
    } {
      \Delta, \alpha \claim \omega
    }

    \inferrule[Match] {
      \widebar{\ \tau\ }^{\cdot \code{$\tau$<:$\alpha$} \in \Delta} = \vec{\tau}
      \\
      \cdot \alpha \mapsto \code{|}(\vec{\tau}) \in \omega
      \\\\
      \forall \tau'\ \tau'' .\  \cdot \alpha \mapsto \tau' \in \omega \rightarrow \cdot \alpha \mapsto \tau'' \in \omega \rightarrow \tau' = \tau''
    } {
      \Delta, \alpha \claim \omega
    }
  \end{mathpar}
...
\end{flalign*}
  \begin{mathpar}
    \inferrule[Extension] {
      ...
      \Delta_0 \preceq \Delta_1
      \\
      \vec{z}_1, \Delta_1 \claim \tau_l \subtypes \tau_u
    } {
      \vec{z}_1, \Delta_1
      \claim 
      \Delta \cdot \code{$\tau_l$<:$\tau_u$}
    }

    \inferrule[Empty] {
    } {
      \vec{z}, \Delta \claim \square
    }
  \end{mathpar}

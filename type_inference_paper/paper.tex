...
\emph{Progression} of an expression, in Definition \ref{definition:progression},
...
The type of a record is an intersection of field types.
...
The recursive case infers inductive types for the parameters and bodies of its
...
\begin{definition} \boxed{\Gamma \entails e \hastype \tau \given \Omega}\ Proof Typing
  ...
  \begin{mathpar}
    ...
    \inferrule {
      \Gamma \entails R \hastype \tau_0 \given \Omega 
      \\
      \Gamma \entails e \hastype \tau_1 \given \Omega' 
      \\
      \Omega \preceq \Omega'
    } {
    ...
    \inferrule {
      \Gamma \entails e_0 \hastype \tau_0 \given \Omega 
      \\
      \Gamma \entails e_1 \hastype \tau_1 \given \Omega' 
      \\
      \Omega \preceq \Omega'
      \\\\
      \tau_0 \subtypes \tau_1\obj{->}\alpha \given \Omega'' 
      \\
      \Omega' \preceq \Omega''
    } {
    ...
    \inferrule {
      ...
      \Gamma \entails \obj{loop($e$)} \hastype \obj{ALL[}\alpha_x \obj{]}\alpha_x\obj{->EXI[}\alpha_y \obj{;} \alpha_x \obj{*} \alpha_y
...
\emph{Proof subtyping}, of definition \ref{definition:proof_subtyping},
...
closed relational constraint

\paragraph{Rule \ref{definition:proof_subtyping}.12}
open relational constraint
...
\begin{definition}\boxed{\tau \subtypes \tau \given \Omega}\ Proof Subtyping
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \tau_l \subtypes \obj{LFP[} \alpha \obj{]} \given \Omega'
    }\lab{10}

    \inferrule {
      \exists \alpha .\ \alpha \in \text{FTV}(\tau_l) \land \alpha \in \vec{\alpha} 
      \\
      \tau_l \subtypes \obj{LFP[}\alpha\obj{]}\tau_r \cong \tau_l' \subtypes \obj{LFP[}\alpha \obj{]} \tau_r'
      \\\\
      \Delta \entails \tau_l' \subtypes \tau_n \sim 
      \\
      \tau_n \subtypes \obj{LFP[}\alpha \obj{]} \tau_r' \entails \Omega
      \\
    ...
    \inferrule {
      \TODO{ensure that all free type variables are open}
      \\\\
      \vec{\alpha} \entails \Delta \wr \text{FTV}(\tau_l) \given \vec{\delta}
      \\
      \entails \tau_l \subtypes \obj{LFP[}\alpha\obj{]}\tau_r \consis 
      \\\\
      \tau_l[\vec{\delta}] \subtypes \obj{LFP[}\alpha\obj{]}\tau_r
      \given \vec{\alpha}_1, \Delta_1
      \\

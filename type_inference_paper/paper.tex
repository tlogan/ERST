...
\begin{figure*}[h]
  ...
  \begin{mathpar}
    ...
    \inferrule[Skip] {
      \neg (z \in \vec{z}_0 \land \tau_l \in \vec{z}_0 \land \tau_r = \alpha)
      \\
      \vec{z}_0, \Delta_0 \claim \vec{z}_1 \lessdot \alpha
    } {
...
\begin{figure*}[h]
  ...
  \begin{mathpar}
    ...
    \inferrule[Flex-R] {
      ...
      \\
      \vec{z}_0, \Delta_0 \claim \alpha \slash \tau_l \lessdot^\diamond \Delta_{skol}
      \\\\
      \vec{z}_0, \Delta_0 \claim \alpha \ll \vec{\tau} 
      \\
      \vec{z}_0, \Delta_0 \claim \alpha \slash \tau_l \ll^\diamond \Delta_{rel}
      \\\\
      \vec{z}_0 \preceq \vec{z}_1
      \\
      \Delta_0 \preceq \Delta_1
      \\\\
      \vec{z}_1, \Delta_1 \claim \Delta_{rel} \code{;$\tau_l$<:}\code{\&}(\vec{\tau})
    } {
      \vec{z}_1, \Delta_1
      \ \widebar{\code{;$\tau_l$<:$z$}}^{z\in\vec{z}}
      \ \Delta_{skol} \cdot \code{$\tau_l$<:$\alpha$} 

...
\begin{lemma}(Elimination of implication of model typing)
  ...
  \item \Z\Z $\textbf{let } v_0 \textbf{ s.t. } v_0 = F\ \code{*$p$=>$e$}$ by definition 
  ...
  \item \Z\Z\Z $\Omega, \Gamma \satisfies v_0\code{(}e_1'\code{)} \hastype \tau_r$ by induction hypothesis
  \item \Z\Z\Z $v_0\code{(}e_1[\Sigma]\code{)} \rightsquigarrow v_0\code{(}e_1'\code{)}$ by definition
  \item \Z\Z\Z $(v_0\code{(}e_1\code{)})[\Sigma] \rightsquigarrow v_0\code{(}e_1'\code{)}$ by definition
  \item \Z\Z\Z $\Omega, \Gamma \satisfies v_0\code{(}e_1\code{)} \hastype \tau_r$ by definition

  \item \Z\Z $\Omega, \Gamma \satisfies v_0\code{(}e_1\code{)} \hastype \tau_r$ by induction on $e_1[\Sigma] \textbf{ wellformed}$

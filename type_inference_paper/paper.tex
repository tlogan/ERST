...
\begin{mathpar}
  ...
  \inferrule[SkolemUpperVar] {
    ...
    \left< \Delta, \Omega \right> \claim \tau_i \subtypes \alpha
  }
...
\begin{mathpar}
  ...
  \inferrule[ReducedUpperLeastFP] {
    interpret\_positive(\Delta, \Omega, \tau_l) = \tau_l'
    \\
    \tau_l' \neq \tau_l
    \\
    \left< \Delta, \Omega \right>
  ...
  \inferrule[LookupUpperLeastFP] {
    lookup\_weak\_normal(\Delta, \tau_l) = \code{LFP[$\alpha$|$\tau_a$]}
    \\
    ordered\_paths(\tau_l) = paths
    \\
    normalize(\code{LFP[$\alpha$|$\tau_u$]}, paths) = \code{LFP[$\alpha$|$\tau_u'$]}
    \\\\
    \left< \Delta, \Omega \right> 
    \claim \code{LFP[$\alpha$|$\tau_a$]} \subtypes \code{LFP[$\alpha$|$\tau_u'$]}
  } {
    \left< \Delta, \Omega \right> 
    \claim \tau_l \subtypes \code{LFP[$\alpha$|$\tau_u$]}
  }

  \inferrule[SaveUpperLeastFP] {

...
\begin{figure*}[h]
  ...
  \begin{mathpar}
    ...
    % TODO: Should read vs write be determined by skolem vs non-skolem?
    % TODO: step 1. get rid of the paths; normalize abstraction should only be in terms of targets

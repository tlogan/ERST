...
\begin{theorem}(Soundness of typing)
  ...
  \begin{itemize}
    \item $\textbf{let}\ e\ \textbf{s.t.}\ e\ \textbf{valid}$
    \item $\textbf{for}\ e'\ \textbf{assume}\ e \rightsquigarrow^\star e'$
      \begin{itemize}
        \item \textbf{case}\ $e = e'$
        \begin{itemize}
          \item $e \rightsquigarrow^\star e$ by semantics 
          \item $e \rightsquigarrow^\star e'$ by substitution 
          \item $e'\ \textbf{valid}$ by substitution
          \item $e\ \textbf{sound}$ by semantics
        \end{itemize}
      \end{itemize}
  \end{itemize}
\end{theorem}

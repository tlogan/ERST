...
\begin{figure*}[h]
  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \claim \vec{z} \lessdot \alpha}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
      \vec{z}, \square \claim \square \lessdot \alpha
    }

    \inferrule[Match] {
      z \in \vec{z}_0
      \\
      \vec{z}_0, \Delta_0 \claim \vec{z}_1 \lessdot \alpha
      \\\\
      \vec{z}_0, \Delta_0 \claim \vec{z}_2 \lessdot z 
    } {
      \vec{z}_0, \Delta_0 \cdot \code{$z$<:$\alpha$} \claim \vec{z}_1\ \vec{z}_2\ z \lessdot \alpha
    }
    ...
    \inferrule[Skip] {
      ...
      \vec{z}_0, \Delta_0 \cdot \code{$\tau_l$<:$\tau_r$} \claim \vec{z}_1 \lessdot \alpha
    }
  \end{mathpar}

  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \claim \vec{\tau} \ll \alpha}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
      \vec{z}, \square \claim \square \ll \alpha
    }

    \inferrule[Direct] {
      \tau \notin \vec{z}
      \\
      \vec{z}, \Delta \claim \vec{\tau} \ll \alpha
    } {
      \vec{z}, \Delta \cdot \code{$\tau$<:$\alpha$} \claim \vec{\tau}\ \tau \ll \alpha
    }

    \inferrule[Trans] {
      z \in \vec{z}
      \\
      \vec{z}, \Delta \claim \vec{\tau}_0 \ll \alpha
      \\\\
      \vec{z}, \Delta \claim \vec{\tau}_1 \ll z 
    } {
      \vec{z}, \Delta \cdot \code{$z$<:$\alpha$} \claim \vec{\tau}_0\ \vec{\tau}_1 \ll \alpha
    }
    ...
    \inferrule[Skip] {
      ...
      \vec{z}, \Delta \cdot \code{$\tau_l$<:$\tau_r$} \claim \vec{\tau} \ll \alpha
    }
  \end{mathpar}

  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \claim \alpha \lessdot \vec{z}}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
      \vec{z}, \square \claim \alpha \lessdot \square
    }

    \inferrule[Match] {
      z \in \vec{z}_0
      \\
      \vec{z}_0, \Delta_0 \claim \alpha \lessdot \vec{z}_1 
      \\\\
      \vec{z}_0, \Delta_0 \claim z \lessdot \vec{z}_2 
    } {
      \vec{z}_0, \Delta_0 \cdot \code{$\alpha$<:$z$} \claim \alpha \lessdot \vec{z}_1\ \vec{z}_2\ z 
    }
    ...
    \inferrule[Skip] {
      ...
      \vec{z}_0, \Delta_0 \cdot \code{$\tau_l$<:$\tau_r$} \claim  \alpha \lessdot \vec{z}_1
    }
  \end{mathpar}

  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \claim \alpha \ll \vec{\tau}}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
      \vec{z}, \square \claim \alpha \ll \square
    }

    \inferrule[Direct] {
      \tau \notin \vec{z}
      \\
      \vec{z}, \Delta \claim \alpha \ll \vec{\tau}
    } {
      \vec{z}, \Delta \cdot \code{$\alpha$<:$\tau$} \claim \alpha \ll \vec{\tau}\ \tau
    }

    \inferrule[Trans] {
      z \in \vec{z}
      \\
      \vec{z}, \Delta \claim \alpha \ll \vec{\tau}_0
      \\\\
      \vec{z}, \Delta \claim z \ll \vec{\tau}_1
    } {
      \vec{z}, \Delta \cdot \code{$\alpha$<:$z$} \claim \alpha \ll \vec{\tau}_0\ \vec{\tau}_1
    }
    ...
    \inferrule[Skip] {
      ...
      \vec{z}, \Delta \cdot \code{$\tau_l$<:$\tau_r$} \claim \alpha \ll \vec{\tau}
    }
  \end{mathpar}
...
\begin{figure*}[h]
  ...
  \begin{mathpar}
    ...
    \inferrule[Flex-L] {
      \alpha \notin \vec{z}_1
      \\
      \vec{z}_0, \Delta_0 \claim \vec{z} \lessdot \alpha
      \\
      \vec{z}_0, \Delta_0 \claim \vec{\tau} \ll \alpha
      \\
      \vec{z}_0 \preceq \vec{z}_1
      \\
      \Delta_0 \preceq \Delta_1
    ...
    \inferrule[Flex-R] {
      \alpha \notin \vec{z}_1
      \\
      \vec{z}_0, \Delta_0 \claim \alpha \lessdot \vec{z}
      \\
      \vec{z}_0, \Delta_0 \claim \alpha \lessdot^\diamond \Delta_{skol}
      \\
      \vec{z}_0, \Delta_0 \claim \alpha \ll \vec{\tau} 
      \\
      \vec{z}_0, \Delta_0 \claim \alpha \ll^\diamond \Delta_{rel}
      \\\\
      \vec{z}_0 \preceq \vec{z}_1
      \\
      \Delta_0 \preceq \Delta_1

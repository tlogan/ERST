...
\begin{lemma}(Elimination of implication of model typing)
  ...
  \item \Z\Z\Z $\Omega, \Gamma \satisfies e_0\code{(}e_1'\code{)} \hastype \tau_r$ by induction hypothesis
  \item \Z\Z\Z $e_0\code{(}e_1[\Sigma]\code{)} \rightsquigarrow e_0\code{(}e_1'\code{)}$
  \item \Z\Z\Z $(e_0\code{(}e_1\code{)})[\Sigma] \rightsquigarrow e_0\code{(}e_1'\code{)}$
  \item \Z\Z\Z $\Omega, \Gamma \satisfies e_0\code{(}e_1\code{)} \hastype \tau_r$ 

  \item \Z\Z $\Omega, \Gamma \satisfies e_0\code{(}e_1\code{)} \hastype \tau_r$ by induction on $e_1[\Sigma] \textbf{ wellformed}$

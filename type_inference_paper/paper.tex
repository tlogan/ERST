...
\[
  ...
  \begin{array}[t]{@{} l}
      ...
      \\
      \I \obj{| (EXI [X Y Z ; ((X,Y),Z) <: R] ((<succ> X),(<succ> Y)),Z)}
      \\
...
\TODO{update code to replace skolem variables based on constraints when constructing type}

\TODO{update code to simplify learnable vairables too}
\[
  \begin{array}[t]{@{} l}
    \obj{TOP}
    \\

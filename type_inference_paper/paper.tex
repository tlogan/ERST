...
\mathbb{V} \owns v &\C{set of values}
  \\
\mathbb{W} \owns (v,v) &\C{set of value-value pairs}
  \\
\mathbb{R} \owns (l,v) &\C{set of label-value pairs}
  \\
...
\begin{mathpar}
  ...
  \inferrule[LowerAny] {
    ...
    \left< \Delta \cup \Delta', \Omega \cup \{\alpha_i\}_i \cup \Omega' \right>
    \claim 
    \code{(ANY[$\widebar{\alpha_i}^i$ $Q$] $\tau_l$)}
    \subtypes 
    \tau_u
  }
  ...
  \inferrule[UpperAny] {
    ...
    \tau_l
    \subtypes 
    \code{(ANY[$\widebar{\alpha_i}^i$ $Q$] $\tau_u$)}
  }

  \inferrule[LearnableSkolemLowerVar] {
    \alpha \notin \Omega 
    \\
    strongest\_upper(\Delta, \alpha) = \alpha' 
    \\
    \alpha' \in \Omega 
    \\\\
    strongest\_upper(\Delta, \alpha') = \tau_l
    \\
  ...
  \inferrule[LearnableSkolemUpperVar] {
    \alpha \notin \Omega 
    \\
    weakest\_lower(\Delta, \alpha) = \alpha'
    \\
    \alpha' \in \Omega 
    \\\\
    weakest\_lower(\Delta, \alpha') = \tau_u
    \\
    \left< \Delta, \Omega \right> \claim \tau_l \subtypes \tau_u
  } {
  ...
  \inferrule[SkolemLowerVar] {
    \alpha \in \Omega
    \\
    weakest\_lower(\Delta, \alpha) = \tau_l
    \\
    \left< \Delta, \Omega \right>
    \claim \tau_l \subtypes \tau_u
  } {
...
\begin{mathpar}
  ...
  \inferrule[LowerLFP] {
    ...
    \left< \Delta, \Omega \right>
    \claim 
    \code{ANY[$\widebar{\alpha_i}^i$ ; $\tau_p$<:LFP[$\alpha$|$\tau_l$]]$\tau_p$}
    \subtypes 
    \tau_u
  } {
    \left< \Delta, \Omega \right>

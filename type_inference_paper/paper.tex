...
\begin{theorem}(Soundness of typing (Alternative))
  ...
  \item \I\I $e\ \textbf{sound}$ by \D{Semantics \ref{semantics:sound_alternative}}
  ...
  \item \I $e\ \textbf{sound}$ by \D{Semantics \ref{semantics:sound_alternative}}

  \item $\square$
\end{theorem}
\TODO{Note that this definition of sound does not require preservation (subject reduction)}

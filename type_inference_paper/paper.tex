...
\begin{figure*}[h]
  ...
  \begin{mathpar}
    ...
    \inferrule[Flex-L] {
      ...
      \Delta_0 \preceq \Delta_1
      \\
      \vec{z}_1, \Delta_1 \claim \code{|}(\vec{\tau}) \subtypes \tau_r
    } {
    ...
    \inferrule[Flex-R] {
      ...
      \Delta_0 \preceq \Delta_1
      \\
      \vec{z}_1, \Delta_1 \claim \widebar{\cdot \code{$\tau_0[\alpha\slash\tau_l]$<:$\tau_1$}}^{\cdot \code{$\tau_0$<:$\tau_1$}\in\Delta_{rel}} \cdot\code{$\tau_l$<:}\code{\&}(\vec{\tau})
    } {
      \vec{z}_1, \Delta_1
    ...
    \inferrule[Skolem-L] {
      \alpha \in \vec{z}
      \\
      \widebar{\tau}^{\cdot \alpha \code{<:} \tau \in (\Delta\ \text{factor}(\Delta, \alpha))} = \vec{\tau}
      \\\\
      \vec{z}, \Delta\claim \code{\&}(\vec{\tau}) \subtypes \tau_r
    } {
    ...
    \inferrule[Skolem-R] {
      \alpha \in \Omega
      \\
      \widebar{\tau}^{\cdot \tau \code{<:} \alpha \in \Delta} = \vec{\tau}
      \\
      \vec{z}, \Delta
      \claim \tau_l \subtypes \code{|}(\vec{\tau})
    } {

...
where a world consists of emph{skolem} type variables and subtyping constraints. 

Whether a variable is a skolem or not represents how a variable is quantified.
If proof typing holds, then its typing holds under every interpretation of its skolem type variables
under some interpretation of its non-skolem variables.
\TODO{show symbolic soundness property}
...
A world is a pair of variables and a constraint environment $(\vec{\alpha},\Delta)$

depends on four parameters: an type variable set, a subtyping environment, 
...
\TODO{describe the essential rules}
...
For an existential assumption, or a universal conclusion, the prover is not free
...
\begin{definition}\boxed{\tau \subtypes \tau \given M, \Delta}\ Proof Subtyping Annex 
  \label{definition:proof_subtyping_annex}
  \begin{mathpar}
    \inferrule {
    } {
...
\begin{definition}\boxed{M, \Delta \entails m <:^\sharp \alpha}\ Lower skolem subtyping 
  \begin{mathpar}
    \inferrule {
      m \in M
      \\
...
\begin{definition}\boxed{M, \Delta \entails \Delta <:^\sharp \alpha \slash \tau}\ Universal lower skolem subtyping
  \begin{mathpar}
    \inferrule {
...
% \begin{definition}\boxed{M, \Delta \entails \alpha <:^\sharp m}\ Upper skolem subtyping 
%   \begin{mathpar}
%     \inferrule {
%       m \in M
%       \\
...
\begin{definition}\boxed{M, \Delta \entails \alpha \slash \tau <:^\sharp \Delta}\ Universal upper skolem subtyping
  \begin{mathpar}
    \inferrule {

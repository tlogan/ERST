...
\begin{theorem}(Model typing implication elimination)
  ...
  \item \Z\Z\Z $\textbf{let}\ \Sigma' \textbf{ s.t. } p \equiv v_1 \given \Sigma'$ by theorem \ref{theorem:model_typing_pattern_matching} 
...
\begin{theorem}(Model typing pattern matching)
  ...
  \TODO{this doesn't actually seem valid}
  \begin{mathpar}
    \inferrule {
      \Omega, \Gamma \satisfies p \hastype \tau 
      \\

...
\begin{definition}\boxed{\tau \subtypes \tau \given M, \Delta}\ (Proof subtyping)
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \\
      M_0, \Delta_0 \entails \Tau <:^\star \alpha
      \\
      M_0 \preceq M_1
      \\
      \Delta_0 \preceq \Delta_1
    ...
    \inferrule {
      ...
      \\
      M_0, \Delta_0 \entails \alpha \lessdot \Delta_{skol}
      \\
      M_0, \Delta_0 \entails \alpha <:^\star \Tau 
      \\
      M_0, \Delta_0 \entails \alpha \ll \Delta_{rel}
      \\\\
      M_0 \preceq M_1
      \\
      \Delta_0 \preceq \Delta_1
...
\begin{definition}\boxed{M, \Delta \entails m <:^\star \alpha} Alternative
  \begin{mathpar}
...
\begin{definition}\boxed{M, \Delta \entails M <:^\star \alpha} Alternative
  \begin{mathpar}
    ...
    \inferrule {
      \forall m .\ m \in M_r \iff  M, \Delta \entails m <:^\star \alpha
    } {
      M, \Delta \entails M_r <:^\star \alpha
    }

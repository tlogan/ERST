    ...
    \item \Z\Z $\B{for } \tau$
      ...
      $
        ...
        \item \Z\Z\Z\Z $
          ...
          \code{ALL[$\alpha_l'$]$\alpha_l'$->EXI[$\alpha_r'$.($\alpha_l'$,$\alpha_r'$)<:FIX[$\alpha_{h^-}$.|$(\Tau)$]]$\alpha_r'$} 
          \given Z_0
        $ by theorem \ref{theorem:universe_proof_typing_transitivity} 
      \item \Z\Z\Z $
        \tau \subtypes \code{$\alpha_l$->$\alpha_r$} \given Z_1
        \implies
        \tau
...
\begin{theorem}(Universe proof typing transitivity)
  \label{theorem:universe_proof_typing_transitivity}
  \begin{mathpar}
    \inferrule { 

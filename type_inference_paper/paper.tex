...
\begin{figure*}[h]
\begin{flalign*}
  &\boxed{\Delta, \Gamma \claim e \hastype \tau}&
\end{flalign*}
  \begin{mathpar}
    \inferrule[Unit] {
    } {
      \Delta, \Gamma \claim \code{@} \hastype \code{@} 
    }

    \inferrule[Var] {
      \cdot \code{$x$:$\tau$} \in \Gamma
    } {
      \Delta, \Gamma \claim x \hastype \tau 
    }

    \inferrule[Tag] {
      \Delta, \Gamma \claim e \hastype \tau 
    } {
      \Delta, \Gamma \claim \code{\ttilde $l$ $e$} \hastype \code{\ttilde $l$ $\tau$} 
    }

    \inferrule[Empty] {
    } {
      \Delta, \Gamma \claim \epsilon \hastype \code{TOP} 
    }

    \inferrule[Record] {
      \Delta, \Gamma \claim r \hastype \tau_0 
      \\
      \Delta, \Gamma \claim e \hastype \tau_1
    } {
      \Delta, \Gamma \claim r\ \code{;$l$=$e$} \hastype \tau_0\ \code{\&}\ \code{$l$:$\tau_1$}
    }
  \end{mathpar}

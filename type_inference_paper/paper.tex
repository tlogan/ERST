...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \\
      \rho \subtypes \tau \rightarrowtail \alpha_\closed \subtypes \tau' 
      \\
...
\begin{definition} 
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \\
      \forall \tau_r .\
      \rho \subtypes \tau \rightarrowtail \alpha_\closed \subtypes \tau_r
      \implies
      \exists \Omega .\  
      (\vec{\alpha}_\closed, \Delta) \preceq \Omega \land
      \tau_l \subtypes \tau_r \given \Omega 
...
\begin{definition} 
  ...
  \hfill
  \boxed{\rho \subtypes \tau \rightarrowtail \alpha \subtypes \tau'}
  \\
  \begin{mathpar}
    \inferrule {
      \TODO{...}
    } {
      \rho \subtypes \tau \rightarrowtail \alpha \subtypes \tau' 
    }
  \end{mathpar}
\end{definition}
\hfill

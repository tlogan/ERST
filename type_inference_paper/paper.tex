...
\begin{lemma}(Elimination of implication of model typing)
  ...
  \item $\textbf{induct on } \Omega, \Gamma \satisfies e_0 \hastype \tau_l \code{->} \tau_r$
  \item \Z $\textbf{case }
    e_0 = \code{($F$ *$p$=>$e$)} 
    \I
  ...
  \item \Z\Z\Z $\textbf{split on}\ F = \epsilon \lor \Omega, \Gamma \satisfies F \hastype \tau_l \code{->} \tau_r$
  ...
  \item \Z\Z\Z\Z $\Omega, \Gamma \satisfies \code{($F$*$p$=>$e$)($e_1$)} \hastype \tau_r$ by definition
  \item \Z\Z\Z $\Omega, \Gamma \satisfies \code{($F$*$p$=>$e$)($e_1$)} \hastype \tau_r$ by splitting 
  \item \Z\Z\Z $\Omega, \Gamma \satisfies \code{(F *$p$=>$e$)}\code{(}e_1'\code{)} \hastype \tau_r$ by application 
  ...
  \item \Z\Z\Z $e_1' = e_1'[\Sigma]$ by lemma \TODO{...} 

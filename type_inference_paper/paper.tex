...
\begin{figure*}[h]
  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \entails \Delta \Rightarrow \vec{z} \lessdot \alpha}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
      \vec{z}, \Delta \entails \epsilon \Rightarrow \epsilon \lessdot \alpha
    }

    \inferrule[Match] {
      z \in \vec{z}_0
      \\
      \vec{z}_0, \Delta_0 \entails \Delta_1 \Rightarrow \vec{z}_1 \lessdot \alpha
      \\\\
      \vec{z}_0, \Delta_0 \entails \Delta_0 \Rightarrow \vec{z}_2 \lessdot z 
    } {
      \vec{z}_0, \Delta_0 
      \entails \Delta_1 \cdot \code{$z$<:$\alpha$} 
    ...
    \inferrule[Skip] {
      ...
      \vec{z}_0, \Delta_0 
      \entails \Delta_1 \cdot \code{$\tau_l$<:$\tau_r$} 
      \Rightarrow \vec{z}_1 \lessdot \alpha
    }
  \end{mathpar}

  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \entails \Delta \Rightarrow \vec{\tau} \ll \alpha}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
      \vec{z}, \Delta \entails \epsilon \Rightarrow \epsilon \ll \alpha
    }

    \inferrule[Direct] {
      \tau \notin \vec{z}
      \\
      \vec{z}, \Delta_0 \entails \Delta_1 \Rightarrow \vec{\tau} \ll \alpha
    } {
      \vec{z}, \Delta_0 \entails \Delta_1 \cdot \code{$\tau$<:$\alpha$} \Rightarrow \vec{\tau}\ \tau \ll \alpha
    }

    \inferrule[Trans] {
      z \in \vec{z}
      \\
      \vec{z}, \Delta_0 \entails \Delta_1 \Rightarrow \vec{\tau}_0 \ll \alpha
      \\
      \vec{z}, \Delta_0 \entails \Delta_0 \Rightarrow \vec{\tau}_1 \ll z 
    } {
      \vec{z}, \Delta_0 \entails \Delta_1 \cdot \code{$z$<:$\alpha$} \Rightarrow \vec{\tau}_0\ \vec{\tau}_1 \ll \alpha
    }
    ...
    \inferrule[Skip] {
      ...
      \vec{z}, \Delta_0 \entails \Delta_1 \cdot \code{$\tau_l$<:$\tau_r$} \Rightarrow \vec{\tau} \ll \alpha
    }
  \end{mathpar}

  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \entails \Delta \Rightarrow \alpha \lessdot \vec{z}}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
      \vec{z}, \Delta \entails \epsilon \Rightarrow \alpha \lessdot \epsilon
    }

    \inferrule[Match] {
      z \in \vec{z}_0
      \\
      \vec{z}_0, \Delta_0 \entails \Delta_1 \Rightarrow \alpha \lessdot \vec{z}_1 
      \\\\
      \vec{z}_0, \Delta_0 \entails \Delta_0 \Rightarrow z \lessdot \vec{z}_2 
    } {
      \vec{z}_0, \Delta_0 \entails \Delta_1 \cdot \code{$\alpha$<:$z$} \Rightarrow \alpha \lessdot \vec{z}_1\ \vec{z}_2\ z 
    }
    ...
    \inferrule[Skip] {
      ...
      \vec{z}_0, \Delta_0 \entails \Delta_1 \cdot \code{$\tau_l$<:$\tau_r$} \Rightarrow  \alpha \lessdot \vec{z}_1
    }
  \end{mathpar}

  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \entails \Delta \Rightarrow \alpha \ll \vec{\tau}}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
      \vec{z}, \Delta \entails \epsilon \Rightarrow \alpha \ll \epsilon
    }

    \inferrule[Direct] {
      \tau \notin \vec{z}
      \\
      \vec{z}, \Delta_0 \entails \Delta_1 \Rightarrow \alpha \ll \vec{\tau}
    } {
      \vec{z}, \Delta_0 \entails \Delta_1 \cdot \code{$\alpha$<:$\tau$} \Rightarrow \alpha \ll \vec{\tau}\ \tau
    }

    \inferrule[Trans] {
      z \in \vec{z}
      \\
      \vec{z}, \Delta_0 \entails \Delta_1 \Rightarrow \alpha \ll \vec{\tau}_0
      \\
      \vec{z}, \Delta_0 \entails \Delta_0 \Rightarrow z \ll \vec{\tau}_1
    } {
      \vec{z}, \Delta_0 \entails \Delta_1 \cdot \code{$\alpha$<:$z$} \Rightarrow \alpha \ll \vec{\tau}_0\ \vec{\tau}_1
    }
    ...
    \inferrule[Skip] {
      ...
      \vec{z}, \Delta_0 \entails \Delta_1 \cdot \code{$\tau_l$<:$\tau_r$} \Rightarrow \alpha \ll \vec{\tau}
    }
  \end{mathpar}
...
\begin{figure*}[h]
  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \entails \Delta \Rightarrow \alpha \lessdot \Delta}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
    ...
    \inferrule[Match] {
      ...
      z_0 \in \vec{z}_0
      \\
      \vec{z}_0, \Delta_0 \entails \Delta_1 \Rightarrow \alpha \lessdot \Delta_2
      \\
      \vec{z}_0, \Delta_0 \entails \Delta_0 \Rightarrow z_0 \lessdot \vec{z}_1 
    } {
      \vec{z}_0, \Delta_0
      \entails
  ...
  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \entails \Delta \Rightarrow \alpha \ll \Delta}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
    ...
    \inferrule[Direct] {
      ...
      \tau \notin \vec{z}
      \\
      \vec{z}, \Delta_0 \entails \Delta_1 \Rightarrow \alpha \ll \Delta_2
    } {
      \vec{z}, \Delta_0 \entails \Delta_1 \cdot \code{$\tau_l$<:$\tau_r$} \Rightarrow \alpha \ll \Delta_2 \cdot \code{$\tau_l$<:$\tau_r$}
    }
    ...
    \inferrule[Trans] {
      ...
      \vec{z}, \Delta_0 \entails \Delta_1 \Rightarrow \alpha \ll \Delta_2
      \\\\
      \vec{z}, \Delta_0 \entails \Delta_0 \Rightarrow z \ll \Delta_3 
    } {
      \vec{z}, \Delta_0 \entails \Delta_1 \cdot \code{$\tau$<:$z$} \Rightarrow \alpha \ll \Delta_2\ \Delta_3
    }
    ...
    \inferrule[Skip] {
      ...
      \vec{z}, \Delta_0 \entails \Delta_1 \cdot \code{$\tau_l$<:$\tau_r$} \Rightarrow \alpha \ll \Delta_2
    }
  \end{mathpar}
...
\begin{figure*}[h]
  ...
  \begin{mathpar}
    ...
    \inferrule[Flex-L] {
      \alpha \notin \vec{z}_0
      \\
      \vec{z}_0, \Delta_0 \entails \Delta_0 \Rightarrow \vec{z} \lessdot \alpha
      \\
      \vec{z}_0, \Delta_0 \entails \Delta_0 \Rightarrow \vec{\tau} \ll \alpha
      \\
      \vec{z}_0 \preceq \vec{z}_1
      \\
      \Delta_0 \preceq \Delta_1
    ...
    \inferrule[Flex-R] {
      \alpha \notin \vec{z}_0
      \\
      \vec{z}_0, \Delta_0 \entails \Delta_0 \Rightarrow \alpha \lessdot \vec{z}
      \\
      \vec{z}_0, \Delta_0 \entails \Delta_0 \Rightarrow \alpha \lessdot \Delta_{skol}
      \\
      \vec{z}_0, \Delta_0 \entails \Delta_0 \Rightarrow \alpha \ll \vec{\tau} 
      \\
...
\begin{figure*}[h]
  ...
  \begin{mathpar}
    ...
    \inferrule[Function] {
      ...
      \\
      \Gamma \entails \vec{\pi} \Rrightarrow \tau
    } {
      \Gamma \entails f \hastype \tau \given \vec{W}
    }
  ...
  \begin{mathpar}
    ...
    \inferrule[Step] {
      ...
      \\\\
      p \liftpat \tau_0 \given \Gamma_1
      \\
      \vec{W}_0 \looparrowright \vec{W}_1
      \\
      \Gamma_0\ \Gamma_1 \entails e \hastype \tau_1 \given \vec{W}_1
      \\
...
\begin{figure*}[h]
  \begin{flalign*}
    &\boxed{\Gamma \entails \vec{\pi} \Rrightarrow \tau}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[TODO] {
    } {
      \vec{\Gamma} \entails \vec{\pi} \Rrightarrow \tau
    }
  \end{mathpar}

  \begin{flalign*}
    &\boxed{\vec{n} \entails \alpha \circlearrowleft \vec{W} \cdot \code{$\alpha$->$\alpha$} \Rrightarrow \alpha \circlearrowright \vec{\tau}}&
  \end{flalign*}
  ...
  \begin{mathpar}
    \inferrule[Empty] {
      ...
      \vec{n} \entails \alpha_0 \circlearrowleft \epsilon \cdot \code{$\alpha_1$->$\alpha_2$} \Rrightarrow \alpha_3 \circlearrowright \epsilon 
    }

    \inferrule[Step] {
      \vec{z}, \Delta \entails \Delta \Rightarrow \vec{\tau} \subtypes \alpha_2
      \\
      \code{($\alpha_1$,|$(\vec{\tau})$)} = \tau_p
      \\
      \text{FTV}(\code{($\alpha_1$,|$(\vec{\tau})$)}) = \vec{\alpha}_0 
      \\
      \text{FTV}(\Delta) = \vec{\alpha}_1
      % TODO: should skolems be added to existential?
    } {
      \vec{n} \entails \alpha_0 \circlearrowleft \vec{W}\ \left<\vec{z},\Delta\right> \cdot \code{$\alpha_1$->$\alpha_2$} \Rrightarrow \alpha_3 \circlearrowright \vec{\tau}\ \tau
    }
  \end{mathpar}

  \begin{flalign*}
    &\boxed{\vec{z}, \Delta \entails \Delta \Rightarrow \vec{\tau} \subtypes \alpha}&
  \end{flalign*}
  \begin{mathpar}
    \inferrule[Empty] {
    } {
      \vec{z}, \Delta \entails \epsilon \Rightarrow \epsilon \subtypes \alpha
    }

    \inferrule[Direct] {
      \tau \notin \vec{z}
      \\
      \vec{z}, \Delta_0 \entails \Delta_1 \Rightarrow \vec{\tau} \subtypes \alpha
    } {
      \vec{z}, \Delta_0 \entails \Delta_1 \cdot \code{$\tau$<:$\alpha$} \Rightarrow \vec{\tau}\ \tau \subtypes \alpha
    }
    ...
    \inferrule[Skip] {
      ...
      \vec{z}, \Delta_0 \entails \Delta_1 \cdot \code{$\tau_l$<:$\tau_r$} \Rightarrow \vec{\tau} \subtypes \alpha
    }
  \end{mathpar}
  ...
  \begin{mathpar}
    \inferrule[Empty] {
      ...
      \vec{z}, \Delta \entails \epsilon \Rightarrow \alpha \subtypes \epsilon
    }

    \inferrule[Direct] {
      \tau \notin \vec{z}
      \\
      \vec{z}, \Delta_0 \entails \Delta_1 \Rightarrow \alpha \subtypes \vec{\tau}
    } {
      \vec{z}, \Delta_0 \entails \Delta_1 \cdot \code{$\tau$<:$\alpha$} \Rightarrow \alpha \subtypes \vec{\tau}\ \tau
    }
    ...
    \inferrule[Skip] {
      ...
      \vec{z}, \Delta_0 \entails \Delta_1 \cdot \code{$\tau_l$<:$\tau_r$} \Rightarrow \alpha \subtypes \vec{\tau}
    }
  \end{mathpar}

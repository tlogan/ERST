...
\begin{theorem}(Proof typing soundness)
  ...
  $ by theorem \ref{theorem:proof_subtyping_specialization}
  ...
  \item \Z \TODO{remaining elimination cases} 
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{theorem}(Proof subtyping specialization)
  \label{theorem:proof_subtyping_specialization}
  \begin{mathpar}
    \inferrule { 
      \tau_l \subtypes \tau_r \given Z 
      \\

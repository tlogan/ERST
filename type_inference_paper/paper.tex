...
\[
  \begin{array}[t]{@{} l}
    \obj{let trivial = (}
      \\
      \I \obj{\$ \tl hello @ => \tl world @}
      \\
      \I \obj{\$ \tl good @ => \tl morning @} 
      \\
      \I \obj{\$ \tl thank @ => \tl you @} 
      \\
    \obj{)}
...
\[
  \obj{(\tl hello @ -> \tl world @) \& (\tl good @ -> \tl morning @) \& (\tl thank @ -> \tl you @)}
\]
...
Consider the application \obj{trivial(x)} where \obj{x} has the type \obj{(\tl hello @)|(\tl thank @)}. 
...
\[
  \begin{array}[t]{@{} l}
      ...
      \I \obj{\$ \tl zero @ => \tl nil @}
      \\
      \I \obj{\$ \tl succ n => \tl cons(x,self(n))}
      \\
      \obj{)}
  \end{array}
\]
...
The type of \obj{repeat} depends on relation between nats and lists (parametrically named here for readability).
\[
  \text{natList}(\alpha) = \begin{array}[t]{@{} l}
      ...
      \I \obj{(\tl zero @)*(\tl nil @) |}
      \\
      \I \obj{(EXI[N L ; N*L <: SELF](\tl succ N)*(\tl cons (}\alpha\obj{*L))}
      \\
      \obj{]} 
  \end{array}
\]
...
It may worth noting that there exists a semantically equivalent type in terms of a greatest fixed point. 
...
\[
  \begin{array}[t]{@{} l}
      ...
      \I \obj{(\tl zero @)->(\tl nil @) \&}
      \\
      \I \obj{(ALL[N L ; SELF <: N->L](\tl succ N)->(\tl cons(T*L))}
      \\
      \obj{]} 
  \end{array}
\]

Type inference reasons in the least fixed point form, but the greatest fixed point form could
be easily handled as syntactic sugar with rewriting.  
...
\paragraph{Fixed point forward path selection.} Consider the application \obj{repeat(\tl succ \tl succ \tl zero @)(@)}. Type inference
constructs a singleton type, mirroring the results achieved by simply running the program.  
\[
  \obj{\tl cons(@*\tl cons(@*\tl nil@))}
\]
...
type is inferred to be an empty list or a singleton list, \obj{\tl nil @ | \tl cons(T,\tl nil @)}.
...
\begin{definition}\boxed{e \rightsquigarrow e}\ Progression
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \obj{\tl$l$ $e$} \rightsquigarrow \obj{\tl$l$ $e'$}
    }
...
\begin{definition}\boxed{e \rightsquigarrow e}\ Progression sugar
  \begin{mathpar}
    ...
    \inferrule {
      \obj{(\$\tl true @=>}e_t \obj{\ \$\tl false @=>}e_f \obj{)(}e_c\obj{)} \rightsquigarrow e'
    } {
...
\begin{definition} \boxed{\Gamma \entails e \hastype \tau \given Z}\ (Proof typing)
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \Gamma \entails \obj{\tl $l$ $e$} \hastype \obj{\tl $l$ $\tau$} \given Z 
    }
...
\begin{definition} \boxed{\tau \subtypes \tau \given M, \Delta}\ (Proof world subtyping)
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \obj{\tl$l$ $\tau_l$} \subtypes \obj{\tl$l$ $\tau_r$}
      \given M, \Delta 
    }
...
\begin{theorem}(Proof typing weak soundness)
  ...
  \item \Z $\B{wrt } e' \ \tau'$ 
    ...
    $ by application
    \item \Z\Z $
      \Omega, \Gamma \satisfies \obj{\tl $l$ $e'$} \hastype \obj{\tl $l$ $\tau'$}
    $ by definition
    \item \Z\Z $
      \Omega, \Gamma \satisfies e \hastype \tau 
    $ by substitution
  ...
  $ 
  \item \Z $\contin  
    \tau = \obj{ALL[$\alpha_l'$]$\alpha_l'$->EXI[$\alpha_r'$.$\alpha_l'$*$\alpha_r'$<:LFP[$\alpha_{h^-}$.|$(\Tau)$]]$\alpha_r$} 
  $
  \item \Z $\contin 
    Z = Z_0 
  $
  ...
  $
    ...
    $
      ...
      \item \Z\Z $\B{case } e'[\Sigma] = v$
        \item \Z\Z\Z $\B{let } v' \B{ s.t. } \obj{\tl}l\ v = v'$
        \item \Z\Z\Z $\obj{\tl}l\ e'[\Sigma] = v'$
        \item \Z\Z\Z $(\obj{\tl}l\ e')[\Sigma] = v'$
        \item \Z\Z\Z $e[\Sigma] = v'$
        \item \Z\Z\Z $\VDash e[\Sigma] $

      \item \Z\Z $\B{case } e'[\Sigma] \rightsquigarrow e'' \I \VDash e''$
        \item \Z\Z\Z $\obj{\tl}l\ e'[\Sigma] \rightsquigarrow \obj{\tl}l\ e''$
        \item \Z\Z\Z $\VDash \obj{\tl}l\ e'' $
        \item \Z\Z\Z $\VDash \obj{\tl}l\ e'[\Sigma] $
        \item \Z\Z\Z $\VDash (\obj{\tl}l\ e')[\Sigma] $
        \item \Z\Z\Z $\VDash e[\Sigma] $

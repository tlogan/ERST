...
\begin{theorem}(Proof typing soundness)
  ...
  $ 
  \item \TODO{redo conditions for looping case}
  \item \Z $
    \text{FTV}(\Gamma) \entails \alpha_{h^+} \cdot Z_1 \cdot \code{$\alpha_l$->$\alpha_r$} \fallingdotseq \alpha_{h^-} \cdot \Tau
    \I
    e = \code{fix($e'$)}
  ...
  \item \TODO{redo how fixpoint duality lemmas are used}
  \item \Z\Z $
    \tau' \subtypes 
...
\begin{theorem}(Fixpoint duality soundness)
  ...
  \begin{mathpar}
    \inferrule { 
      ...
      \\\\
      \forall M'\ \Delta' .\ \left< M', \Delta' \right> \in Z \implies M \preceq M' \land \Delta \preceq \Delta' 
    } {
  ...
  \end{mathpar}
  \TODO{induct on fixpoint duality}
  Proof: 
\end{theorem}

...
\begin{figure*}[h]
  ...
  \end{array}\]
    ...
    % \ \text{map}_{z\in\vec{z}}(\code{;$\tau_l$<:$z$})

  \begin{flalign*}
    &{\boxed{\text{map}_{\square\in C}(c)}}&
  \end{flalign*}

  \[\begin{array}{rclr}
    \text{map}_{\square \in \epsilon}(c)
    &=& 
    \epsilon
    & \C{epsilon} 
    \\
...
\begin{mathpar}
  ...
  \inferrule[Flex-L] {
    \alpha \notin Z_1
    \\\\
    Z_0, \Delta_0 \claim \vec{z} \lessdot \alpha
    \\
    ...
    Z_1, \Delta_1\ \text{map}_{z\in\vec{z}}(\code{;$z$<:$\tau_r$}) \cdot \code{$\alpha$<:$\tau_r$} \claim 
    \alpha \subtypes \tau_r
  }
  ...
  \inferrule[Flex-R] {
    \alpha \notin Z_1
    \\\\
    Z_0, \Delta_0 \claim \alpha \lessdot \vec{z}
    \\
    Z_0, \Delta_0 \claim \alpha \slash \tau_l \lessdot^\diamond \Delta_{skol}
    \\\\
    ...
    \Delta_0 \preceq \Delta_1
    \\\\
    Z_1, \Delta_1 \claim \Delta_{rel} \code{;$\tau_l$<:}\code{\&}(\vec{\tau})
  } {
    Z_1, \Delta_1
    \ \text{map}_{z\in\vec{z}}(\code{;$\tau_l$<:$z$})

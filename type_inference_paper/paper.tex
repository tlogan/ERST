...
strengthen the lower bound or weaken the upper bound occur before rules that
weaken the lower bound or strengthen the upper bound.
...
For a lower bound least fixed point, $\obj{LFP[} \alpha \obj{]} \tau_l$, proof subtyping  
...
For an upper bound difference, $\tau_r\obj{\textbackslash}\eta$, proof subtyping,
...
For a lower bound union, $\tau_{ll}\obj{|}\tau_{lr}$, proof subtyping
...
the continued definition \ref{def:continued_proof_subtyping}.

\paragraph{Rule \ref{def:proof_subtyping}.5}
For a lower bound existential, $\obj{EXI[}\vec{\alpha}\ \Delta\obj{]}\tau_l$, proof subtyping 
...
For an upper bound existential, $\obj{EXI[}\vec{\alpha}\ \Delta\obj{]}\tau_r$ ,proof subtyping

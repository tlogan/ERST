...
}\ Negative Prune Interpretation 
\label{def:negative_prune_interpretation}
  \begin{mathpar}
    \inferrule {
      \llbracket \text{extract}(\vec{\alpha}_\closed, \alpha \entails \Delta)^-\backslash\Delta, \alpha \rrbracket^- = (\Delta', \tau)
    } {
      \llbracket \vec{\alpha}_\closed \entails \Delta, \alpha \rrbracket^- = (\Delta', \tau)
    }
  \end{mathpar}
...
\begin{definition}\boxed{
  \text{indirect}(\vec{\alpha}_\bullet, \alpha \entails \Delta)^- = \Delta'
}\ Negative Indirect Extraction 
\label{def:negative_indirect_extraction}
  \begin{mathpar}
  \end{mathpar}
\end{definition}
...
\label{def:negative_interpretation}
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \llbracket \epsilon, \alpha \rrbracket \subtypes (\epsilon, \obj{TOP})
    }

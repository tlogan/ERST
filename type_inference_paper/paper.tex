...
\begin{definition}\boxed{\vec{\alpha} \entails \vec{\pi} \cong \vec{\tau}}\ Constrained Implication Congruence 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \\\\
      \vec{\alpha}_f, \vec{\alpha}_c, \Delta \entails \tau_l\obj{->}\tau_r \cong^{+} \tau
    } {
      \vec{\alpha}_f \entails \vec{\pi}\ \left<\vec{\alpha}_c, \Delta, \tau_l \obj{->} \tau_r \right> \cong \vec{\tau}\ \tau 
    }
  \end{mathpar}
\end{definition}
...
\begin{definition}
\boxed{\vec{\alpha} \entails \text{GFP}[\alpha]\vec{\Omega} \Rightarrow \alpha \rightarrow \alpha \fallingdotseq \text{LFP}[\alpha]\vec{\Omega} \times \alpha * \alpha}
\ Fixpoint Duality 
\label{def:fixpoint_duality}
...
\Gamma, ... \satisfies (e_l,e_r) : \alpha_l \obj{*} \alpha_r
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \vec{\alpha}_f \entails 
      \text{GFP}[\alpha_{\nu}] \epsilon \Rightarrow \alpha_l \rightarrow \alpha_r 
      \fallingdotseq 
      \text{LFP}[\alpha_{\mu}]\epsilon \times \alpha_l * \alpha_r 
    }
    ...
    \inferrule {
      ...
      \Delta_\nu \entails \alpha_{\nu} \subtypes \vec{\tau}_\nu
      \\
      [\alpha_\nu]\Delta \fallingdotseq [\alpha_\mu]\Delta
    } {
      \vec{\alpha}_f \entails 
      \text{GFP}[\alpha_{\nu}]\vec{\Omega}_\nu\ \left< \vec{\alpha}_c,\Delta_\nu \right> \Rightarrow \alpha_l \rightarrow \alpha_r 
      \fallingdotseq 
      \text{LFP}[\alpha_{\mu}] \vec{\Omega}_\mu\ \left< \vec{\alpha}_c,\Delta_\mu \right> \times \alpha_l * \alpha_r 
    }
  \end{mathpar}
\end{definition}
...
\begin{definition}\boxed{\vec{\alpha} \entails \vec{\Omega} \times \alpha_l * \alpha_r \cong \vec{\tau}}\ Pair Type Congruence 
\label{def:fixpoint_congruence}
  \begin{mathpar}
    \inferrule {
    } {
      \vec{\alpha}_f \entails \epsilon \times \alpha_l * \alpha_r \cong \epsilon 
    }

    \inferrule {
      \vec{\alpha}_f \entails \vec{\Omega} \times \alpha_l * \alpha_r \cong \vec{\tau}
      \\
      \Delta_\nu \entails \alpha_l \subtypes \vec{\tau}_l 
      \\
      \Delta_\nu \entails \vec{\tau}_r \subtypes \alpha_r
      \\\\
      \vec{\alpha}_f, \vec{\alpha}_c, \Delta \entails \text{inter}(\vec{\tau}_l)\obj{*}\text{union}(\vec{\tau}_r) \cong^{-} \tau
    } {
      \vec{\alpha}_f \entails \vec{\Omega}\ \left<\vec{\alpha}_c, \Delta \right> \times \alpha_l * \alpha_r \cong \vec{\tau}\ \tau
    }
  \end{mathpar}
\end{definition}

...
\begin{theorem}(Proof typing soundness)
  ...
  \end{mathpar}
  \TODO{convert to using existential $\Omega$}
  ...
  $
    \item \Z\Z $\B{for } \tau$
      ...
      $
        ...
        \item \Z\Z\Z\Z $
          \exists M\ \Delta\ .\ \left<M, \Delta\right> \in \epsilon 
  ...
  $
    ...
    \item \Z\Z $\B{for } \tau$
      ...
      $
        ...
        \item \Z\Z\Z\Z $
          \exists \tau'\ \tau'' .\ 
          \tau \subtypes \code{$\tau'$\&$\tau''$}\given Z\ \left<M, \Delta\right>
        ...
        \item \Z\Z\Z\Z $
          ...
          \code{ALL[$\alpha_l'$]$\alpha_l'$->EXI[$\alpha_r'$.($\alpha_l'$,$\alpha_r'$)<:FIX[$\alpha_{h^-}$.|$(\Tau)$]]$\alpha_r'$} 
          \given Z_0
        $ by theorem \ref{theorem:universe_proof_subtyping_transitivity} 
      \item \Z\Z\Z $
        \tau \subtypes \code{$\alpha_l$->$\alpha_r$} \given Z_1
        \implies
        \tau
...
\begin{theorem}(Universe proof subtyping transitivity)
  \label{theorem:universe_proof_subtyping_transitivity}
  \begin{mathpar}
    \inferrule { 
      \tau_0 \subtypes \tau_1 \given Z
      \\
      \tau_1 \subtypes \tau_2 \given Z
    } {
      \tau_0 \subtypes \tau_2 \given Z
    } 
  \end{mathpar}
  Proof: 
  \item \TODO{...} 
...
\begin{theorem}(Proof subtyping soundness)
  ...
  $
    ...
    \item \Z $\B{wrt } \tau $
      \item \Z\Z $\B{for } \Omega $
        \item \Z\Z\Z $\Omega \satisfies \tau \subtypes \tau$
        by theorem \ref{...} \TODO{model typing reflexivity}
        \item \Z\Z\Z $\Omega \satisfies \tau_l \subtypes \tau_r$ by substitution 
        \item \Z\Z\Z $\exists \Omega .\ \Omega \satisfies \tau_l \subtypes \tau_r$ by witness 
      \item \Z\Z $\forall \Omega .\ \exists \Omega .\ \Omega \satisfies \tau_l \subtypes \tau_r$ by generalization 
      \item \Z\Z $\exists \Omega .\ \Omega \satisfies \tau_l \subtypes \tau_r$ by independence 
    ...
    %   \item \Z\Z $\B{for } e\ \Gamma \B{ assume } \Omega, \Gamma \satisfies e \hastype \tau_l$
    %     \item \Z\Z\Z $...$
    %     \item \Z\Z\Z $\Omega, \Gamma \satisfies e \hastype \tau_r$
    %     by ... 
    %   \item \Z\Z $\forall e\ \Gamma .\ \Omega, \Gamma \satisfies e \hastype \tau_l \implies \Omega, \Gamma \satisfies e \hastype \tau_r$ 
    %   by implication and generalization
    %   \item \Z\Z $\Omega \satisfies \tau_l \subtypes \tau_r$ by definition
    %   \item \Z\Z $\exists \Omega .\ \Omega \satisfies \tau_l \subtypes \tau_r$ by witness 

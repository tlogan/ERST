...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \rho\obj{\textbackslash}\eta \subtypes \tau \given \Omega
    }
  \end{mathpar}
\end{definition}
\hfill
...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \tau \subtypes \rho\obj{\textbackslash}\eta
      \given \Omega 
    }
  \end{mathpar}
\end{definition}
...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \\
      \forall \alpha .\ \alpha \in \text{FTV}(\rho) \implies \alpha \notin \vec{\alpha} 
      \\\\
      \vec{\alpha} \entails \Delta \wr \text{FTV}(\rho) \given \vec{\delta}
      \\
      \rho[\vec{\delta}] \subtypes \obj{LFP[}\alpha\obj{]}\tau
      \given \vec{\alpha}', \Delta'
    } {
      \rho \subtypes \obj{LFP[}\alpha\obj{]}\tau

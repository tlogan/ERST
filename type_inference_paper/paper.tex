...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      \TODO{make sure interpretation doesn't unsafely strengthen the closed variable}
      \\\\
      \nexists \psi.\ \tau_r = \psi
      \\
...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      \TODO{make sure interpretation doesn't unsafely weaken the closed variable}
      \\\\
      \nexists \phi.\ \tau_l = \phi
      \\
      \alpha_\closed \in \vec{\alpha}_\closed 

...
\begin{theorem}(Typing Soundness)
  ...
  \item $\B{assume } \entails e \hastype \tau \given Z$
    ...
    \item \Z $e[\Sigma] \B{ wellformed} $ by theorem \ref{theorem:model_typing_soundness}
    \item \Z $e[\Sigma] = e$ by ...
    \item \Z $e \B{ wellformed} $ by substitution 
  \item $\square$
\end{theorem}
...
\begin{theorem}(Proof subtyping soundness)
  ...
  $
    ...
    \item \Z $\B{wrt } \tau $
      \item \Z\Z $\B{let } \Omega $
      \item \Z\Z $\Omega \satisfies \tau \subtypes \tau$
      by theorem \ref{...} \TODO{model typing reflexivity}
      \item \Z\Z $\Omega \satisfies \tau_l \subtypes \tau_r$ by substitution 
      \item \Z\Z $\exists \Omega .\ \Omega \satisfies \tau_l \subtypes \tau_r$ by witness 

    \item \Z $\B{case } \tau_l = \code{BOT}$
      \item \Z\Z $\B{let } \Omega $
      \item \Z\Z $\Omega \satisfies \code{BOT} \subtypes \tau_r$ by definition
      \item \Z\Z $\Omega \satisfies \tau_l \subtypes \tau_r$ by substitution 
      \item \Z\Z $\exists \Omega .\ \Omega \satisfies \tau_l \subtypes \tau_r$ by witness 

    \item \Z $\B{case } \tau_r = \code{TOP}$
      \item \Z\Z $\B{let } \Omega $
      \item \Z\Z $\Omega \satisfies \tau_l \subtypes \code{TOP}$ by definition
      \item \Z\Z $\Omega \satisfies \tau_l \subtypes \tau_r$ by substitution 
      \item \Z\Z $\exists \Omega .\ \Omega \satisfies \tau_l \subtypes \tau_r$ by witness 

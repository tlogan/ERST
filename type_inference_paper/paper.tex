...
\[
  \obj{(\ttilde hello @ -> \ttilde world @) \& (\ttilde good @ -> \ttilde morning @)}
\]
...
Consider the application $\obj{trivial(\ttilde hello @)}$. 
Type inference breaks apart the intersection into paths and finds that only one path 
matches the type of the argument. It determines the type of the application to be the singleton
$\obj{\ttilde world @}$.

...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \\\\
      \exists \Delta' .\ \llbracket \Delta, \alpha_\closed \rrbracket^- = (\Delta', \tau_l)
      \\\\
      \exists \Omega .\ 
      (\vec{\alpha}_\closed \cup \text{FTV}(\tau_l), \Delta) \preceq \Omega \land
      \tau_l \subtypes \tau_r \given \Omega 
    } {
...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \\\\
      \exists \Delta' .\ \llbracket \Delta, \alpha_\closed \rrbracket^+ = (\Delta', \tau_r)
      \\\\
      \exists \Omega .\ 
      (\vec{\alpha}_\closed \cup \text{FTV}(\tau_l), \Delta) \preceq \Omega \land \tau_l \subtypes \tau_r \given \Omega 
    } {

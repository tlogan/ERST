...
\begin{theorem}(Elimination of implication of model typing)
  ...
  \item \Z\Z $\textbf{let } v_0 \textbf{ s.t. } v_0 = \code{(F *$p$=>$e$)}[\Sigma]$ by theorem \TODO{... inversion ...} 
  ...
  \item \Z\Z\Z\Z $\textbf{let } e' \textbf{ s.t. } (\code{$F$($e_1$}))[\Sigma] \rightsquigarrow e' \land \Omega, \Gamma \satisfies e' \hastype \tau_r$ by theorem \TODO{inversion} 
...
% \begin{theorem}(Preservation of model typing)
%   \label{theorem:model_typing_preservation}
%   \begin{mathpar}
%     \inferrule {

...
\begin{definition}\boxed{\tau \subtypes \tau \given \Omega}\ Proof Subtyping
  ...
  \begin{mathpar}
    ...
    \inferrule {
      \TODO{modify to interpret previous constraints in terms of new constraint. }
      \\\\
      \TODO{this requires knowing the intro/elim position of variable. only sub for intro positions}
      \\\\
      \alpha \notin \vec{\alpha}
      \\\\
    ...
    \inferrule {
      \TODO{require that for all previous constraints $\alpha$ is alone in intro position}
      \\\\

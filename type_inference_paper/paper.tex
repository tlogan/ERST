...
\begin{proof}
  ...
  $ 
    ...
    $
      ...
      \item \Z\Z $\VDash e_1[\Sigma]$ by theorem \ref{theorem:model_typing_soundness}



      \item \Z\Z $\B{induct on}\ \VDash e_1[\Sigma]$
      ...
      \item \Z\Z $\B{case}\ e_1[\Sigma] \rightsquigarrow e_1' \I \VDash e_1'$
      \item \Z\Z $\B{hypo}\ \VDash e_1' \implies \Omega, \Gamma \satisfies \code{($F$\$$p$=>$e$)($e_1'$)} \hastype \tau_r$
      \item \Z\Z $\B{wrt}\ e_1' $

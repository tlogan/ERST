...
mutual
  ...
  | var name' =>
    ...
    intro h0 h1 h2 h3 h4 h5 P h6 h7 h8
    simp [*]
    exists P
    simp [*]
    rw [find_drop _ _ h0]
  ...
  | path left right =>
    ...
    simp [*]
    apply And.intro
    { apply Typ.wellformed_instantiate_var_preserved h7 }
    { intro arg h9
  ...
  | lfp b body =>
    simp [Typ.free_vars, Typ.instantiate, Typing]
    intro h0 h1 h2 h3 h4 h5 h6 name' h7 h8 h9 h10 h11
    simp [*]
    exists name'
    simp [*]
    apply And.intro

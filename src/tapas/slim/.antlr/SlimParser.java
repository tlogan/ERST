	...
	public final Typ_baseContext typ_base() throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				_localctx.combo = TTag((((Typ_baseContext)_localctx).ID!=null?((Typ_baseContext)_localctx).ID.getText():null), ((Typ_baseContext)_localctx).typ.combo) 
			...
			case 5:
				...
				_localctx.combo = TField((((Typ_baseContext)_localctx).ID!=null?((Typ_baseContext)_localctx).ID.getText():null), ((Typ_baseContext)_localctx).typ.combo) 

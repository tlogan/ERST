...
For syntax that represents complete expressions, e.g. \[ :uno @ \], the inherited type represents the expected type for that expression.
...
There is no type for this syntax. Thus, the inherited type represents the type that \[ .dos \] is expected to project from (or cut into), 

...
\begin{mathpar}
  ...
  \inferrule[StrongExisEmpty] {
    \bigand_i \alpha_i \notin FTV(\Delta_i)
    \\
    \left< \Delta_i, \Omega_i \right> \rightsquigarrow \left< \Delta_h, \Omega_h \right> 
    \claim \tau_s \subtypes \tau_w
  } {
    \left< \Delta_i, \Omega_i \right> \rightsquigarrow \left< \Delta_o, \Omega_o \cup \right> 
    \claim 

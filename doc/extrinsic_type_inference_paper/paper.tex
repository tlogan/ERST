...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \\
      \alpha \circlearrowleft \Pi \subtypes \tau'
    } {
...
\begin{definition} 
  ...
  \hfill 
  \small
  \boxed{\alpha \circlearrowleft \Pi \subtypes \tau}
  \nopad
  \begin{mathpar}
    \inferrule {
    ...
    \inferrule {
      ...
      \alpha \circlearrowleft (\Theta'', \Delta'', \alpha_l \J{->}\tau_r) \subtypes \alpha_l \J{->} \J{LFP[} \alpha \J{]} \tau_r''
    }
  \end{mathpar}
\end{definition}

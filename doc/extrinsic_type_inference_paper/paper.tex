...
\title{Fully Extrinsic Type Inference (DRAFT 2025-06-17)}
\author{Thomas Logan}
...
\TODO{lean uses the term "metavariable" for our concept of "plastic variable". Should we conform to Lean's terminology?}
...
\TODO{We use the term "plastic variable" to avoid the potentially misleading terminology of "meta variable"}

\TODO{Other options are "unknown", "hole", "logic variable", "placeholder", "schematic variable"}

\TODO{replace "plastic" with "placeholder"}

...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    \inferrule {
      ...
      \Theta, \Delta, \Gamma \entails e \hastype \Pi
      \\
      \textbf{pack}^+(\Theta \cup \textbf{ftv}(\Delta) \cup \textbf{ftv}(\Gamma) \entails \Pi) = \tau_e
      \\\\
      \exists \Theta^\dagger, \Delta^\dagger \qua \Theta', \Delta' \entails \tau_e \subtypes \tau_a \given \Theta^\dagger, \Delta^\dagger
    } {

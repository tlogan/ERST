...
\begin{definition} 
  ...
  \begin{mathpar}
    \inferrule {
      \Vdash \J{LFP[}\alpha\J{]}\tau_l \subtypes l \mapsto \tau_f 
      \\
      \Theta, \Delta \entails \tau_f \subtypes \tau_r \given \Theta', \Delta' 
    } {
      \Theta, \Delta \entails 
...
\begin{definition} 
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \\\\
      \Theta, \Delta \not\Vvdash \tau \subtypes \tau_r
      \\
      \Theta, \Delta \not\Vvdash \tau_r \subtypes \tau
      \\

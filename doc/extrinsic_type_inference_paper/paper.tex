...
\begin{definition} 
  ...
  \begin{mathpar}
    ...
    %% projection is just syntactic sugar for application with pattern matching
    % \inferrule {
    %   \Theta, \Delta, \Gamma \entails e \hastype \tau \given \Theta', \Delta' 
    %   \\\\
    %   \Theta', \Delta' \entails 
    ...
    \inferrule {
      ...
      \\
      \textbf{pack}^-(\alpha\ \textbf{ftv}(\Delta') \entails \Pi') = \tau'
      \\\\
    ...
    \inferrule {
      \Theta, \Delta, \Gamma \entails e \hastype \tau \given  \Theta', \Delta'
      \\
      \Theta', \Delta' \entails \tau \subtypes \alpha \rightarrow (\Theta'', \Delta'', \alpha_l \J{->}\tau_r)
      \\
      \alpha \notin \textbf{ftv}(\Delta')
      \\
      \alpha \neq \alpha_l
      ...
      \\
      \textbf{pack}^-(\alpha\ \alpha_l\ \textbf{ftv}(\Delta') \entails \Theta'', \Delta''', \alpha_l \J{*} \tau_r) = \tau'
      \\\\
      \textbf{factor}(\alpha \entails \tau' \cdot \J{left}) = \tau_l
      \\
      \textbf{factor}(\alpha \entails \tau' \cdot \J{right}) = \tau_r'
      ...
      \alpha_l \wr^+ \tau_r'
      \\
      \textbf{found}(\alpha \entails \tau_l) = \tau_l'
      \\
      \tau_r'[\alpha_l\slash \J{LFP[} \alpha \J{]} \tau_l'] = \tau_r''
    } {
      \Theta, \Delta, \Gamma \entails \J{loop(}e\J{)} 
      \hastype 
      \alpha_l \J{->} \J{LFP[} \alpha \J{]} \tau_r''
      \given \Theta', \Delta'
    }

    %% replaced by syntactic sugar over application and simpler annotation rule
    % \inferrule {
    ...
    %   \\
    %   \Theta', \Delta', x:\tau_a\ \Gamma \backslash x, \entails e' \hastype \tau' \given \Theta'', \Delta''
    % } {
...
\begin{definition} 
  ...
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta \entails 
      \textbf{factor}(\alpha \entails \tau_l \cdot l) 
      \subtypes 
...
\begin{definition} 
  ...
  \begin{mathpar}
    \inferrule {
      ...
      \\
      \Theta, \Delta \restricted \tau_r \subtypes  \tau
      \\\\
...
\begin{definition} 
  ...
  \begin{mathpar}
    \inferrule {
      \Theta, \Delta \circlearrowleft \tau_l \subtypes \J{LFP[} \alpha \J{]} \tau_r
      \\
      \Theta, \Delta \entails
...
\ms{
... \circlearrowleft \tau_l \subtypes \J{LFP[} \alpha \J{]} \tau_r

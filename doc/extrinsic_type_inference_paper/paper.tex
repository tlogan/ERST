...
\begin{definition}
  \label{def:model_core_typing}
  \emph{model core typing}
  \hfill
  \small
  \boxed{\delta \VDash e \hastype \tau}
  \nopad
  \begin{mathpar}
    \inferrule { 
      \alpha \wr^+ \tau
      \\
      \exists n \qua e \hastype \tau[\alpha \slash \J{BOT}]^n 
    } {
      \delta \VDash e \hastype \J{LFP[}\alpha\J{]}\tau 
    } 
  \end{mathpar}
\end{definition}

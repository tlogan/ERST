...
\TODO{say what it means simply}
This property is necessary so that our proof typing rules can use positive substitution
as a proxy reasoning under the induction hypothesis. 

\TODO{add requirements on factoring, packing, and tidying, and negatble checks}

...
\TODO{add requirements on factoring, packing, polar sub and tidying, and negatble checks}
...
developed ways to infer type instantiations and compare type with varying
amounts of possible instantiations, by combining impredicative types
with subtyping and type inference techniques. Bidirectional type inference \cite{}  

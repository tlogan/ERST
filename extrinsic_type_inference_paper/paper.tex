...
\TODO{add requirements on packing, polar sub and tidying, and negatble checks}

\TODO{for polar sub, dye type by subbing in a fresh skolem}
...
introduced into ML-style languages with boxed polymorphism \cite{} 
and developed further with ML$^F$ \cite{} and various other systems \cite{}. 
...
\TODO{mention impredicative types with subtyping, bidirectional typing, local type inferenc (Pierce)}

\TODO{mention how inferring parameter types and instations is processed before and independent from their subtyping check}
...
\TODO{mention algebraic subtyping, Cretin, and flow analysis}

\TODO{note how solving subtyping constraints subsume the notion of bidirection typig}
...
\TODO{discuss implicit and flow based approaches}

\TODO{enumerate the various work with various type forms}

\TODO{note how our structural requirements on recursive types prevent typing generators}

\TODO{note the distinction between our least fixed point types and the more general 
recursive types}

...
\begin{requirement}
  \label{req:proof subtyping completeness under negatability}
  \emph{proof subtyping completeness under negatability}  
  \small
  \nopad
  \begin{mathpar}
    \inferrule {
...
\begin{requirement}
  \label{req:proof subtyping existential completeness under negatability}
...
\TODO{add requirements on tidying}

\TODO{add requirements on factoring}
